...
class CreateMhpMedicationChartPartThreeMedicineSevenTablesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mhp_medication_chart_part_three_medicine_seven_tables', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('mhp_medication_chart_part_three_medicine_seven_tables');
    }
}
