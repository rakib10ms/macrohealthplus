...
class CreateMhpMentalPsq9Ques2ndsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mhp_mental_psq9_ques2nds', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('mhp_mental_psq9_ques2nds');
    }
}
