...
function EditTongueMouth(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-tongue-mouth/${lastpart}`).then(res => {

            if (res.data.status === 200) {
                console.log(res.data);
                settonguemouth(res.data.tonguemouth);
                // setPicture(res.data.tonguemouth.image);
    ...
    const handleInput = (e) => {
        e.persist();
        settonguemouth({ ...tonguemouth, [e.target.name]: e.target.value });
    }

    const updateTongueMouthInput = (e) => {
        e.preventDefault();
        ...
        axios.post(`/update-tongue-mouth/${lastpart}`, formData).then(res => {
            if (res.data.status === 200) {
                    ...
                    <div className="col-md-9 mt-3">
                        <div className="card">
                            <div className="card-header">
                                <h6 className="card-title"> Edit Tongue Mouth
                                    <Link to={'/tongue-mouth'} className="btn btn-primary btn-sm float-end"> Back </Link>
                                </h6>
                            </div>
                            <div className="card-body">
                                <form id="TongueMouthForm" onSubmit={updateTongueMouthInput}>
                                    <div className="card-body">
                                        ...
                                        <div className="col-md-12">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <span className="text-danger">{error.tonguemouth_name}</span>
                                            </div>
...
export default EditTongueMouth;
