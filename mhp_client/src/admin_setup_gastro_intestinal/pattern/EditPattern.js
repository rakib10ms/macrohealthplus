...
function EditPattern(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-pattern/${lastpart}`).then(res => {

            if (res.data.status === 200) {
                console.log(res.data);
                setPattern(res.data.Pattern);
                // setPicture(res.data.Pattern.image);
    ...
    const updatePatternInput = (e) => {
        ...
        axios.post(`/update-pattern/${lastpart}`, formData).then(res => {
            if (res.data.status === 200) {
                    ...
                    <div className="col-md-9 mt-3">
                        <div className="card">
                            <div className="card-header">
                                <h6 className="card-title"> Edit Pattern
                                    <Link to={'/pattern'} className="btn btn-primary btn-sm float-end"> Back </Link>
                                </h6>
                            </div>
                            <div className="card-body">
                                <form id="PatternForm" onSubmit={updatePatternInput}>
                                    <div className="card-body">
                                        ...
                                        <div className="col-md-12">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <span className="text-danger">{error.Pattern_name}</span>
                                            </div>
