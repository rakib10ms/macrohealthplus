...
function AddAttitute() {
    ...
    const handleInput=(e)=>{
       setattitute({
           ...attitute,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal=(e)=>{     
        e.preventDefault();
        const data={
            attitute_name:attitute.attitute_name,
            status_id:attitute.status_id,
            selection_criteria:attitute.selection_criteria,
        }
    
        axios.post(`/save-attitute`,data).then(res=>{
            if(res.data.status==200){
               ...
               setattitute({
                ...
                setattitute({ ...attitute, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add Attitute Towards
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{attitute.error_list.attitute_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={attitute.status_id} name="status_id"
                            ...
                            <span className="text-danger">{attitute.error_list.status_id}</span>
            ...
            <span className="text-danger">{attitute.error_list.selection_criteria}</span>
