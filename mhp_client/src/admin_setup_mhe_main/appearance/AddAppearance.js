...
function AddAppearance() {
    ...
    const handleInput=(e)=>{
       setappearanceInput({
           ...appearanceInput,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal=(e)=>{     
        e.preventDefault();
        const data={
            appearance_name:appearanceInput.appearance_name,
            status_id:appearanceInput.status_id,
            selection_criteria:appearanceInput.selection_criteria,
        }
    
        axios.post(`/save-appearance`,data).then(res=>{
            if(res.data.status==200){
               ...
               setappearanceInput({
                ...
                setappearanceInput({ ...appearanceInput, error_list: res.data.errors });
    ...
    <div className="container">
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{appearanceInput.error_list.appearance_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={appearanceInput.status_id} name="status_id"
                            ...
                            <span className="text-danger">{appearanceInput.error_list.status_id}</span>
            ...
            <span className="text-danger">{appearanceInput.error_list.selection_criteria}</span>
