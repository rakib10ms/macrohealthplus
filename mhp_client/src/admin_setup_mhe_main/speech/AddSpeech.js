...
function AddSpeech() {
    ...
    const handleInput=(e)=>{
       setspeech({
           ...speech,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal=(e)=>{     
        ...
        const data={
            ...
            status_id:speech.status_id,
            selection_criteria:speech.selection_criteria,
        }
    
        axios.post(`/save-speech`,data).then(res=>{
            if(res.data.status==200){
               ...
               setspeech({
                ...
                setspeech({ ...speech, error_list: res.data.errors });
    ...
    <div className="container">
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{speech.error_list.speech_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={speech.status_id} name="status_id"
                            ...
                            <span className="text-danger">{speech.error_list.status_id}</span>
            ...
            <span className="text-danger">{speech.error_list.selection_criteria}</span>
