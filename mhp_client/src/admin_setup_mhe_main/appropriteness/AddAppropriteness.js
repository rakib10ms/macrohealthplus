...
function AddAppropriteness() {
    ...
    const handleInput=(e)=>{
       setappropriteness({
           ...appropriteness,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal=(e)=>{     
        e.preventDefault();
        const data={
            appropriteness_name:appropriteness.appropriteness_name,
            status_id:appropriteness.status_id,
            selection_criteria:appropriteness.selection_criteria,
        }
    
        axios.post(`/save-appropriteness`,data).then(res=>{
            if(res.data.status==200){
               ...
               setappropriteness({
                ...
                setappropriteness({ ...appropriteness, error_list: res.data.errors });
    ...
    <div className="container">
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{appropriteness.error_list.appropriteness_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={appropriteness.status_id} name="status_id"
                            ...
                            <span className="text-danger">{appropriteness.error_list.status_id}</span>
            ...
            <span className="text-danger">{appropriteness.error_list.selection_criteria}</span>
...
export default AddAppropriteness
