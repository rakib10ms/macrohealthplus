...
function AddMood() {
    ...
    const handleInput=(e)=>{
       setmood({
           ...mood,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal=(e)=>{     
        ...
        const data={
            ...
            status_id:mood.status_id,
            selection_criteria:mood.selection_criteria,
        }
    
        axios.post(`/save-mood`,data).then(res=>{
            if(res.data.status==200){
               ...
               setmood({
                ...
                setmood({ ...mood, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add Mood
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{mood.error_list.mood_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={mood.status_id} name="status_id"
                            ...
                            <span className="text-danger">{mood.error_list.status_id}</span>
            ...
            <span className="text-danger">{mood.error_list.selection_criteria}</span>
