...
function AddBehaviour() {
    ...
    const handleInput=(e)=>{
       setbehaviourInput({
           ...behaviourInput,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal=(e)=>{     
        e.preventDefault();
        const data={
            behaviour_name:behaviourInput.behaviour_name,
            status_id:behaviourInput.status_id,
            selection_criteria:behaviourInput.selection_criteria,
        }
    
        axios.post(`/save-behaviour`,data).then(res=>{
            if(res.data.status==200){
               ...
               setbehaviourInput({
                ...
                setbehaviourInput({ ...behaviourInput, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add Behaviour
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{behaviourInput.error_list.behaviour_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={behaviourInput.status_id} name="status_id"
                            ...
                            <span className="text-danger">{behaviourInput.error_list.status_id}</span>
            ...
            <span className="text-danger">{behaviourInput.error_list.selection_criteria}</span>
