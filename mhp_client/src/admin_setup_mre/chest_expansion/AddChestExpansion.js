...
function AddChestExpansion() {
    ...
    const handleInput=(e)=>{
       setchestexpansion({
           ...chestexpansion,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal = (e) => {
        ...
        axios.post(`/save-chest-expansion`, formData).then(res => {
            if (res.data.status == 200) {
                ...
                setchestexpansion({ ...chestexpansion, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add Chest Expansion
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{chestexpansion.error_list.chestexpansion_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={chestexpansion.status_id} name="status_id"
                            ...
                            <span className="text-danger">{chestexpansion.error_list.status_id}</span>
            ...
            <span className="text-danger">{chestexpansion.error_list.selection_criteria}</span>

            <div className="form-group mt-3">
                                                    <label htmlFor="inputEmail4"
                                                        className="form-label col-form-label col-form-label-sm"> ChestExapansion Image</label>
...
export default AddChestExpansion
