...
function EditVocalResonance(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-vocal-resonance/${lastpart}`).then(res => {

            if (res.data.status === 200) {
                setvocalresonance(res.data.vocalresonance);
                setPicture(res.data.vocalresonance.image);
    ...
    const handleInput = (e) => {
        e.persist();
        setvocalresonance({ ...vocalresonance, [e.target.name]: e.target.value });
    }
    ...
    const updateCanalInput= (e) => {
        ...
        axios.post(`/update-vocal-resonance/${lastpart}`, formData).then(res => {
            if (res.data.status === 200) {
        ...
        <div className="row">
            ...
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Edit Vocal Resonance
                ...
                <div className="card-body">
                    ...
                    <div className="col-md-12">
                        ...
                        <div className="form-group">
                            ...
                            <span className="text-danger">{error.vocalresonance_name}</span>
                ...
                <div className='form-group mt-3'>
                    ...
                    <div class="form-check form-check-inline ">
                        <input className="form-check-input mt-1" type="radio"onChange={handleInput} value="single" checked={vocalresonance.selection_criteria=='single'?true:''} name="selection_criteria"  id="inlineRadio1"/>
                        <label className="form-check-label" for="inlineRadio1"> <span style={{marginLeft:"-28px"}}>Single </span></label>
                        </div>
                        <div className="form-check form-check-inline">
                        <input className="form-check-input mt-1" type="radio" onChange={handleInput} name="selection_criteria" value="multiple" checked={vocalresonance.selection_criteria=='multiple'?true:''}  id="inlineRadio2"/>
            ...
            <div className="form-group mt-3">
                                                    ...
                                                    {imageUrl == null ? <img src={`${global.img_url}/images/files/vocalresonance/${picture}`} className="doctorImageUrlPreview" /> :
...
export default EditVocalResonance
