...
function AddVocalFremitus() {
    ...
    const handleInput=(e)=>{
       setvocalfremitus({
           ...vocalfremitus,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal=(e)=>{     
        ...
        axios.post(`/save-vocal-fremitus`,formData).then(res=>{
            if(res.data.status==200){
               ...
               document.getElementById('PatientImageUrl').value = '';
                ...
                setvocalfremitus({ ...vocalfremitus, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add Vocal Fremitus
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{vocalfremitus.error_list.vocalfremitus_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={vocalfremitus.status_id} name="status_id"
                            ...
                            <span className="text-danger">{vocalfremitus.error_list.status_id}</span>
            ...
            <span className="text-danger">{vocalfremitus.error_list.selection_criteria}</span>
            ...
            <div className="form-group mt-3">
                                                ...
                                                {/* <span className="text-danger">{vocalfremitus.error_list.image}</span> */}
...
export default AddVocalFremitus
