...
function EditWheering(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-wheering/${lastpart}`).then(res => {

            if (res.data.status === 200) {
                setwheering(res.data.wheering);
                setPicture(res.data.wheering.image);
    ...
    const handleInput = (e) => {
        e.persist();
        setwheering({ ...wheering, [e.target.name]: e.target.value });
    }
    ...
    const updateCanalInput= (e) => {
        ...
        axios.post(`/update-wheering/${lastpart}`, formData).then(res => {
            if (res.data.status === 200) {
        ...
        <div className="row">
            ...
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Edit Wheering
                ...
                <div className="card-body">
                    ...
                    <div className="col-md-12">
                        ...
                        <div className="form-group">
                            ...
                            <span className="text-danger">{error.wheering_name}</span>
                ...
                <div className='form-group mt-3'>
                    ...
                    <div class="form-check form-check-inline ">
                        <input className="form-check-input mt-1" type="radio"onChange={handleInput} value="single" checked={wheering.selection_criteria=='single'?true:''} name="selection_criteria"  id="inlineRadio1"/>
                        <label className="form-check-label" for="inlineRadio1"> <span style={{marginLeft:"-28px"}}>Single </span></label>
                        </div>
                        <div className="form-check form-check-inline">
                        <input className="form-check-input mt-1" type="radio" onChange={handleInput} name="selection_criteria" value="multiple" checked={wheering.selection_criteria=='multiple'?true:''}  id="inlineRadio2"/>
            ...
            <div className="form-group mt-3">
                                                    ...
                                                    {imageUrl == null ? <img src={`${global.img_url}/images/files/wheering/${picture}`} className="doctorImageUrlPreview" /> :
