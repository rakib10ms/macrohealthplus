...
function AddBreathSound() {
    ...
    const handleInput=(e)=>{
       setbreathsound({
           ...breathsound,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal = (e) => {
        ...
        axios.post(`/save-breathsound`, formData).then(res => {
            if (res.data.status == 200) {
                ...
                setbreathsound({ ...breathsound, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add Breath Sound
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{breathsound.error_list.breathsound_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={breathsound.status_id} name="status_id"
                            ...
                            <span className="text-danger">{breathsound.error_list.status_id}</span>
            ...
            <span className="text-danger">{breathsound.error_list.selection_criteria}</span>
