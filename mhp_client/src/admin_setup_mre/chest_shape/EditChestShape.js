...
function EditChestShape(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-chestshape/${lastpart}`).then(res => {

            if (res.data.status === 200) {
                console.log(res.data);
                setchestshape(res.data.chestshape);
                setPicture(res.data.chestshape.image);
    ...
    const handleInput = (e) => {
        e.persist();
        setchestshape({ ...chestshape, [e.target.name]: e.target.value });
    }
    ...
    const updateCanalInput= (e) => {
        ...
        formData.append('chestshape_name',  chestshape.chestshape_name);
        formData.append('status_id', chestshape.status_id);
        formData.append('selection_criteria', chestshape.selection_criteria);
    
    
        axios.post(`/update-chestshape/${lastpart}`, formData).then(res => {
            if (res.data.status === 200) {
        ...
        <div className="row">
            ...
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Edit ChestShape
                        <Link to={'/chestshape'} className="btn btn-primary btn-sm float-end"> Back </Link>
                    </h6>
                </div>
                <div className="card-body">
                    ...
                    <div className="col-md-12">
                        ...
                        <div className="form-group">
                            ...
                            <input type="text"  value={chestshape.chestshape_name} className="form-control" name="chestshape_name" onChange={handleInput} />
                            <span className="text-danger">{error.chestshape_name}</span>
                        ...
                        <select id="inputState" onChange={handleInput} value={chestshape.status_id} name="status_id"
                ...
                <div className='form-group mt-3'>
                    ...
                    <div class="form-check form-check-inline ">
                        <input className="form-check-input mt-1" type="radio"onChange={handleInput} value="single" checked={chestshape.selection_criteria=='single'?true:''} name="selection_criteria"  id="inlineRadio1"/>
                        <label className="form-check-label" for="inlineRadio1"> <span style={{marginLeft:"-28px"}}>Single </span></label>
                        </div>
                        <div className="form-check form-check-inline">
                        <input className="form-check-input mt-1" type="radio" onChange={handleInput} name="selection_criteria" value="multiple" checked={chestshape.selection_criteria=='multiple'?true:''}  id="inlineRadio2"/>
            ...
            <div className="form-group mt-3">
                                                    ...
                                                    {imageUrl == null ? <img src={`${global.img_url}/images/files/chestshape/${picture}`} className="doctorImageUrlPreview" /> :
