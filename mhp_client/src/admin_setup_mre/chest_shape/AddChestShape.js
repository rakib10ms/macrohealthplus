...
function AddChestShape() {
    ...
    const handleInput = (e) => {
        setchestshape({
            ...chestshape, [e.target.name]: e.target.value
        });
    }
    ...
    const submitCanal = (e) => {
        ...
        axios.post(`/save-chestshape`, formData).then(res => {
            if (res.data.status == 200) {
                ...
                setchestshape({ ...chestshape, error_list: res.data.errors });
                        ...
                        <div className="col-md-9 mt-3">
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="card-title"> Add Chest Shape
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <span className="text-danger">{chestshape.error_list.chestshape_name}</span>
                                                ...
                                                <div>
                                                    ...
                                                    <span className="text-danger">{chestshape.error_list.status_id}</span>
                                                ...
                                                <span className="text-danger">{chestshape.error_list.selection_criteria}</span>


                                                <div className="form-group mt-3">
                                                    <label htmlFor="inputEmail4"
                                                        className="form-label col-form-label col-form-label-sm"> ChestShape Image </label>
                                                ...
                                                <span className="text-danger">{chestshape.error_list.image}</span>
