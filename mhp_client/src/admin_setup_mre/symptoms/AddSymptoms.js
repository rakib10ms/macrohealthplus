...
function AddSymptoms() {
    ...
    const handleInput=(e)=>{
       setsymptoms({
           ...symptoms,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal=(e)=>{     
        e.preventDefault();
        const data={
           symptoms_name:symptoms.symptoms_name,
            status_id:symptoms.status_id,
            selection_criteria:symptoms.selection_criteria,
        }
    
        axios.post(`/save-symptoms`,data).then(res=>{
            console.log("sym",res.data)
            if(res.data.status==200){
               ...
               symptoms_name:"",
                ...
                setsymptoms({ ...symptoms, error_list: res.data.errors });
    ...
    <div className="container">
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{symptoms.error_list.symptoms_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={symptoms.status_id} name="status_id"
                            ...
                            <span className="text-danger">{symptoms.error_list.status_id}</span>
            ...
            <span className="text-danger">{symptoms.error_list.selection_criteria}</span>
