...
function EditPercussion(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-percussion/${lastpart}`).then(res => {

            if (res.data.status === 200) {
                setpercussion(res.data.percussion);
                setPicture(res.data.percussion.image);
    ...
    const handleInput = (e) => {
        e.persist();
        setpercussion({ ...percussion, [e.target.name]: e.target.value });
    }
    ...
    formData.append('percussion_name',  percussion.percussion_name);
    formData.append('status_id', percussion.status_id);
    formData.append('selection_criteria', percussion.selection_criteria);
    ...
    const updateCanalInput= (e) => {
        ...
        axios.post(`/update-percussion/${lastpart}`, formData).then(res => {
            if (res.data.status === 200) {
        ...
        <div className="row">
            ...
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Edit Percussion
                        <Link to={'/percussion'} className="btn btn-primary btn-sm float-end"> Back </Link>
                    </h6>
                </div>
                <div className="card-body">
                    ...
                    <div className="col-md-12">
                        ...
                        <div className="form-group">
                            ...
                            <input type="text"  value={percussion.percussion_name} className="form-control" name="percussion_name" onChange={handleInput} />
                            <span className="text-danger">{error.percussion_name}</span>
                        ...
                        <select id="inputState" onChange={handleInput} value={percussion.status_id} name="status_id"
                ...
                <div className='form-group mt-3'>
                    ...
                    <div class="form-check form-check-inline ">
                        <input className="form-check-input mt-1" type="radio"onChange={handleInput} value="single" checked={percussion.selection_criteria=='single'?true:''} name="selection_criteria"  id="inlineRadio1"/>
                        <label className="form-check-label" for="inlineRadio1"> <span style={{marginLeft:"-28px"}}>Single </span></label>
                        </div>
                        <div className="form-check form-check-inline">
                        <input className="form-check-input mt-1" type="radio" onChange={handleInput} name="selection_criteria" value="multiple" checked={percussion.selection_criteria=='multiple'?true:''}  id="inlineRadio2"/>
            ...
            <div className="form-group mt-3">
                                                    <label htmlFor="inputEmail4"
                                                        className="form-label col-form-label col-form-label-sm">Percussion Image </label>
                                                    ...
                                                    {imageUrl == null ? <img src={`${global.img_url}/images/files/percussion/${picture}`} className="doctorImageUrlPreview" /> :
