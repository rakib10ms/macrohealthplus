...
function AddPercussion() {
    ...
    const handleInput=(e)=>{
       setpercussion({
           ...percussion,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal = (e) => {
        e.preventDefault();
        axios.post(`/save-percussion`, formData).then(res => {
            if (res.data.status == 200) {
                ...
                setpercussion({ ...percussion, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add Percussion
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{percussion.error_list.percussion_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={percussion.status_id} name="status_id"
                            ...
                            <span className="text-danger">{percussion.error_list.status_id}</span>
            ...
            <span className="text-danger">{percussion.error_list.selection_criteria}</span>
            ...
            <div className="form-group mt-3">
                                                ...
                                                <span className="text-danger">{percussion.error_list.image}</span>
