...
function AddCrepitation() {
    ...
    const handleInput=(e)=>{
       setcrepitation({
           ...crepitation,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal=(e)=>{     
        ...
        axios.post(`/save-crepitation`,formData).then(res=>{
            if(res.data.status==200){
               ...
               document.getElementById('PatientImageUrl').value = '';
                ...
                setcrepitation({ ...crepitation, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add Crepitation
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{crepitation.error_list.crepitation_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={crepitation.status_id} name="status_id"
                            ...
                            <span className="text-danger">{crepitation.error_list.status_id}</span>
            ...
            <span className="text-danger">{crepitation.error_list.selection_criteria}</span>
            ...
            <div className="form-group mt-3">
                                                ...
                                                <span className="text-danger">{crepitation.error_list.image}</span>
