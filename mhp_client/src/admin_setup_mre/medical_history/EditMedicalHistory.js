...
function EditMedicalHistory(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-medical-history/${lastpart}`).then(res => {

            if (res.data.status === 200) {
                console.log(res.data);
                setmedicalhistory(res.data.medicalhistory);
                // setPicture(res.data.medicalhistory.image);
    ...
    const updateMedicalHistoryInput = (e) => {
        e.preventDefault();
        ...
        axios.post(`/update-medical-history/${lastpart}`, formData).then(res => {
            if (res.data.status === 200) {
                    ...
                    <div className="col-md-9 mt-3">
                        <div className="card">
                            <div className="card-header">
                                <h6 className="card-title"> Edit Medical History
                                    <Link to={'/medical-history'} className="btn btn-primary btn-sm float-end"> Back </Link>
                                </h6>
                            </div>
                            <div className="card-body">
                                <form id="MedicalHistoryForm" onSubmit={updateMedicalHistoryInput}>
                                    <div className="card-body">
                                        ...
                                        <div className="col-md-12">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <span className="text-danger">{error.medicalhistory_name}</span>
                                            </div>
