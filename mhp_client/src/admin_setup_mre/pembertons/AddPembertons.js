...
function AddPembertons() {
    ...
    const handleInput=(e)=>{
       setpembertons({
           ...pembertons,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal=(e)=>{     
        e.preventDefault();
        const data={
           pembertons_name:pembertons.pembertons_name,
            status_id:pembertons.status_id,
            selection_criteria:pembertons.selection_criteria,
        }
    
        axios.post(`/save-pembertons`,data).then(res=>{
            if(res.data.status==200){
               ...
               pembertons_name:"",
                ...
                setpembertons({ ...pembertons, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add Pembertons
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{pembertons.error_list.pembertons_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={pembertons.status_id} name="status_id"
                            ...
                            <span className="text-danger">{pembertons.error_list.status_id}</span>
            ...
            <span className="text-danger">{pembertons.error_list.selection_criteria}</span>
