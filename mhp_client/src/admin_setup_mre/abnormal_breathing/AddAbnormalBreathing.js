...
function AddAbnormalBreathing() {
    ...
    const handleInput=(e)=>{
       setabnormalbreathing({
           ...abnormalbreathing,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal = (e) => {
        ...
        axios.post(`/save-abnormal-breathing`, formData).then(res => {
            if (res.data.status == 200) {
                ...
                setabnormalbreathing({ ...abnormalbreathing, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add Abnormal Breathing
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{abnormalbreathing.error_list.abnormalbreathing_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={abnormalbreathing.status_id} name="status_id"
                            ...
                            <span className="text-danger">{abnormalbreathing.error_list.status_id}</span>
            ...
            <span className="text-danger">{abnormalbreathing.error_list.selection_criteria}</span>
...
export default AddAbnormalBreathing
