...
function AddCnNine() {
    ...
    const handleInput=(e)=>{
       setcnNine({
           ...cnNine,[e.target.name]:e.target.value
       });
    }
    ...
    //   console.log(cnNine);
        ...
        axios.post(`/save-cnNine`,cnNine).then(res=>{
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add CN-IX
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{cnNine.error_list.name}</span>
