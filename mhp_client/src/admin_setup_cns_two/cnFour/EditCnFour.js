...
function EditCnFour(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-cnFour/${lastpart}`).then(res => {
    ...
    const handleInput = (e) => {
        e.persist();
        setcnFour({ ...cnFour, [e.target.name]: e.target.value });
    }

    const updatecnFour= (e) => {
        e.preventDefault();
        ...
        const data = cnFour;
        axios.post(`/update-cnFour/${lastpart}`, data).then(res => {
            if (res.data.status === 200) {
        ...
        <div className="row">
            ...
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Edit CN-IV
                        <Link to={'/cnFour'} className="btn btn-primary btn-sm float-end"> Back </Link>
                    </h6>
                </div>
                <div className="card-body">
                    <form id="EarcnFourForm" onSubmit={updatecnFour}>
                        <div className="card-body">
