...
function AddGasReflex() {
    ...
    const handleInput=(e)=>{
       setgasreflex({
           ...gasreflex,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal=(e)=>{     
        e.preventDefault();
        const data={
           gasreflex_name:gasreflex.gasreflex_name,
            status_id:gasreflex.status_id,
            selection_criteria:gasreflex.selection_criteria,
        }
    
        axios.post(`/save-gasreflex`,data).then(res=>{
            if(res.data.status==200){
               ...
               gasreflex_name:"",
                ...
                setgasreflex({ ...gasreflex, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add Gas Reflex
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{gasreflex.error_list.gasreflex_name}</span>
            ...
            <span className="text-danger">{gasreflex.error_list.selection_criteria}</span>
