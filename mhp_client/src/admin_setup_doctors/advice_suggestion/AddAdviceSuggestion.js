...
class AddAdviceSuggestion extends Component {
    ...
    saveTobaccoTypes = async (e) => {
        ...
        const res = await axios.post('/save-advice-suggestion', this.state);
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="form-group">
                                                    <label htmlFor="asset_color" className="col-form-label-sm">Advice Suggestion Name</label>
...
export default AddAdviceSuggestion;