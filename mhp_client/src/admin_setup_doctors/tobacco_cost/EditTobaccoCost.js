...
class EditTobaccoCost extends Component {
    ...
    async componentDidMount() {
        ...
        const res = await axios.get(`/edit-tobacco-cost/${lastpart}`);
        console.log(res);
        if (res.data.status === 200) {
            this.setState({
                tobacco_cost_amounts_name: res.data.tobacco_cost_amounts.tobacco_cost_amounts_name,
            });
    ...
    updateTobaccoCost = async (e) => {
        ...
        const res = await axios.put(`/update-tobacco-cost/${lastpart}`, this.state);
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="form-group">
                                                    <label htmlFor="tobacco_cost_amounts_name" className="col-form-label-sm">Tobacco Cost Name</label>
...
export default EditTobaccoCost;