...
const AddBillingProvider = () => {
    ...
    const SubmitBillingProvider = (e) => {
        
        e.preventDefault();
        axios.post("/add-billing-provider ",billingProvider)
        .then(res=>{
            // console.log("billingProvider",res)
            if (res.data.status == 200) {
                ...
                setBillingProvider({...billingProvider,error:res.data.message.name[0]})
            }
        })
    }
    return (
                ...
                <div className="col-md-9 mt-3">
                    <div className="card">
                        <div className="card-header">
                            <h6 className="card-title"> Add Billing Provider.
                                <Link to={'/billing-provider'} className="btn btn-primary btn-sm float-end"> Back </Link>
                            </h6>
                        </div>
                        <div className="card-body">
                            <form id="BillingProviderForm" onSubmit={SubmitBillingProvider}>
                                <div className="card-body">
                                    ...
                                    <div className="col-md-12">
                                        <div className="mb-3">
                                            ...
                                            <span className='text-danger'>{billingProvider.error}</span>
                                        </div>
...
export default AddBillingProvider;