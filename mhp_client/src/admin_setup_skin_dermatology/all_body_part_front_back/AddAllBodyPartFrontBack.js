...
function AddAllBodyPartFrontBack() {

    const [AllBodyPartFrontBack, setAllBodyPartFrontBack] = useState({
        AllBodyPartFrontBack_name: "",
        error_list: [],
    });

    const handleInput = (e) => {
        setAllBodyPartFrontBack({
            ...AllBodyPartFrontBack, [e.target.name]: e.target.value
        });
    }
    ...
    const submitAllBodyPartFrontBack = (e) => {
        // alert("hgfdhgf")
        e.preventDefault();
        console.log(e)
        axios.post(`/save-all-body-part-front-back`, formData).then(res => {
            ...
            if (res.data.status == 200) {
                ...
                setAllBodyPartFrontBack({ ...AllBodyPartFrontBack, error_list: res.data.errors });
                        ...
                        <div className="col-md-9 mt-3">
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="card-title"> Add All Body Part Front Back
                                        <Link to={'/all-body-part-front-back'} className="btn btn-primary btn-sm float-end"> Back </Link>
                                    </h6>
                                </div>
                                <div className="card-body">
                                    <form id="AllBodyPartFrontBackForm" onSubmit={submitAllBodyPartFrontBack}>
                                        <div className="card-body">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <span className="text-danger">{AllBodyPartFrontBack.error_list.AllBodyPartFrontBack_name}</span>
...
export default AddAllBodyPartFrontBack;
