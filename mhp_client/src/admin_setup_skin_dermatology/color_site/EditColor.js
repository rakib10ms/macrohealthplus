...
function EditColor(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-color/${lastpart}`).then(res => {

            if (res.data.status === 200) {
                // console.log(res.data.Color);
                setColor(res.data.Color);
                // setPicture(res.data.Color.image);
    ...
    const updateColorInput = (e) => {
        ...
        axios.post(`/update-color/${lastpart}`, formData).then(res => {
            if (res.data.status === 200) {
                    ...
                    <div className="col-md-9 mt-3">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <form id="ColorForm" onSubmit={updateColorInput}>
                                    <div className="card-body">
                                        ...
                                        <div className="col-md-12">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <span className="text-danger">{error.Color_name}</span>
                                            </div>
