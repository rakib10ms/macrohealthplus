...
function EditSkinType(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-skin-type/${lastpart}`).then(res => {
    ...
    const handleInput = (e) => {
        e.persist();
        setSkinType({ ...skinType, [e.target.name]: e.target.value });
    }

    const updateSkinTypeInput = (e) => {
        e.preventDefault();
        ...
        axios.post(`/update-skin-type/${lastpart}`, formData).then(res => {
            if (res.data.status === 200) {
                    ...
                    <div className="col-md-9 mt-3">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <form id="SkinTypeForm" onSubmit={updateSkinTypeInput}>
                                    <div className="card-body">
