...
const AddPainOverPosterior = () => {
    ...
    const SubmitPainOverPosterior = (e) => {
        // alert("painOverPosterior")
        e.preventDefault();
        axios.post("/add-pain-over-posterior",painOverPosterior)
        .then(res=>{
                ...
                <div className="col-md-9 mt-3">
                    <div className="card">
                        <div className="card-header">
                            <h6 className="card-title"> Add Pain Over Posterior
                                <Link to={'/pain-over-posterior'} className="btn btn-primary btn-sm float-end"> Back </Link>
                            </h6>
                        </div>
                        <div className="card-body">
                            <form id="PainOverPosteriorForm" onSubmit={SubmitPainOverPosterior}>
                                <div className="card-body">
...
export default AddPainOverPosterior;