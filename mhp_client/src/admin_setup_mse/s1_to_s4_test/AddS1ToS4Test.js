...
const AddS1ToS4Test = () => {
    ...
    const SubmitS1ToS4Test = (e) => {
        // alert("s1ToS4Test")
        e.preventDefault();
        axios.post("/add-s1-to-s4-test",s1ToS4Test)
        .then(res=>{
            if (res.data.status == 200) {
                ...
                setS1ToS4Test({...s1ToS4Test,error:res.data.message.name[0]})
            }
        })
    }
    return (
                ...
                <div className="col-md-9 mt-3">
                    <div className="card">
                        <div className="card-header">
                            <h6 className="card-title"> Add S1 To S4 Test
                                <Link to={'/s1-to-s4-test'} className="btn btn-primary btn-sm float-end"> Back </Link>
                            </h6>
                        </div>
                        <div className="card-body">
                            <form id="S1ToS4TestForm" onSubmit={SubmitS1ToS4Test}>
                                <div className="card-body">
                                    ...
                                    <div className="col-md-12">
                                        <div className="mb-3">
                                            ...
                                            <span className='text-danger'>{s1ToS4Test.error}</span>
                                        </div>
