...
const AddWalkOnHeels = () => {
    ...
    const SubmitWalkOnHeels = (e) => {
        // alert("walkOnHeels")
        e.preventDefault();
        axios.post("/add-walk-on-heels",walkOnHeels)
        .then(res=>{
            if (res.data.status == 200) {
                ...
                setWalkOnHeels({...walkOnHeels,error:res.data.message.name[0]})
            }
        })
    }
    return (
                ...
                <div className="col-md-9 mt-3">
                    <div className="card">
                        <div className="card-header">
                            <h6 className="card-title"> Add Walk On Heels
                                <Link to={'/walk-on-heels'} className="btn btn-primary btn-sm float-end"> Back </Link>
                            </h6>
                        </div>
                        <div className="card-body">
                            <form id="WalkOnHeelsForm" onSubmit={SubmitWalkOnHeels}>
                                <div className="card-body">
                                    ...
                                    <div className="col-md-12">
                                        <div className="mb-3">
                                            ...
                                            <span className='text-danger'>{walkOnHeels.error}</span>
                                        </div>
