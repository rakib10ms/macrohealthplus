...
const AddTendernessOverFacetThoraco = () => {
    ...
    const SubmitTendernessOverFacetThoraco = (e) => {
        // alert("tendernessOverFacetThoraco")
        e.preventDefault();
        axios.post("/add-tenderness-over-facet-thoraco",tendernessOverFacetThoraco)
        .then(res=>{
                ...
                <div className="col-md-9 mt-3">
                    <div className="card">
                        <div className="card-header">
                            <h6 className="card-title"> Add Tenderness Over Facet Joint
                                <Link to={'/tenderness-over-facet-thoraco'} className="btn btn-primary btn-sm float-end"> Back </Link>
                            </h6>
                        </div>
                        <div className="card-body">
                            <form id="InspectionForm" onSubmit={SubmitTendernessOverFacetThoraco}>
                                <div className="card-body">
...
export default AddTendernessOverFacetThoraco;