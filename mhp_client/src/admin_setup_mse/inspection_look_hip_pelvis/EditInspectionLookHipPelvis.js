...
const EditInspectionLookHipPelvis = () => {
    ...
    useEffect(() => {
        axios.get(`/edit-inspection-look-hip-pelvis/${params.id}`)
            .then(res => setInspectionLookHipPelvis(res.data.inspectionLookHipPelvis))
    }, []);
    const updateInspectionLookHipPelvis = (e) => {
        console.log("inspectionLookHipPelvis", inspectionLookHipPelvis)
        e.preventDefault();
        axios.post(`/update-inspection-look-hip-pelvis/${params.id}`, inspectionLookHipPelvis)
            .then(res => {
                ...
                <div className="col-md-9 mt-3">
                    <div className="card">
                        ...
                        <div className="card-body">
                            <form id="InspectionLookHipPelvisForm" onSubmit={updateInspectionLookHipPelvis}>
                                <div className="card-body">
...
export default EditInspectionLookHipPelvis;