...
const AddPainfulArc = () => {
    ...
    const SubmitPainfulArc = (e) => {
        // alert("painfulArc")
        e.preventDefault();
        axios.post("/add-painful-arc",painfulArc)
        .then(res=>{
            if (res.data.status == 200) {
                ...
                setPainfulArc({...painfulArc,error:res.data.message.name[0]})
            }
        })
    }
    return (
                ...
                <div className="col-md-9 mt-3">
                    <div className="card">
                        <div className="card-header">
                            <h6 className="card-title"> Add Painful Arc
                                <Link to={'/painful-arc'} className="btn btn-primary btn-sm float-end"> Back </Link>
                            </h6>
                        </div>
                        <div className="card-body">
                            <form id="PainfulArcForm" onSubmit={SubmitPainfulArc}>
                                <div className="card-body">
                                    ...
                                    <div className="col-md-12">
                                        <div className="mb-3">
                                            ...
                                            <span className='text-danger'>{painfulArc.error}</span>
                                        </div>
