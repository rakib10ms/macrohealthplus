...
const AddMoveHipPelvis = () => {
    ...
    const SubmitMoveHipPelvis = (e) => {
        // alert("moveHipPelvis")
        e.preventDefault();
        axios.post("/add-move-hip-pelvis",moveHipPelvis)
        .then(res=>{
                ...
                <div className="col-md-9 mt-3">
                    <div className="card">
                        <div className="card-header">
                            <h6 className="card-title"> Add Move Hip Pelvis
                                <Link to={'/move-hip-pelvis'} className="btn btn-primary btn-sm float-end"> Back </Link>
                            </h6>
                        </div>
                        <div className="card-body">
                            <form id="InspectionForm" onSubmit={SubmitMoveHipPelvis}>
                                <div className="card-body">
...
export default AddMoveHipPelvis;