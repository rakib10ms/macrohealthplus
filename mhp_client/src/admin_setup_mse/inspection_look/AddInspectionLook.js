...
const AddInspectionLook = () => {
    ...
    const SubmitInspectionLook = (e) => {
        // alert("inspectionLook")
        e.preventDefault();
        axios.post("/add-inspection-look",inspectionLook)
        .then(res=>{
            if (res.data.status == 200) {
                ...
                setInspectionLook({...inspectionLook,error:res.data.message.name[0]})
            }
        })
    }
    return (
                ...
                <div className="col-md-9 mt-3">
                    <div className="card">
                        ...
                        <div className="card-body">
                            <form id="InspectionForm" onSubmit={SubmitInspectionLook}>
                                <div className="card-body">
                                    ...
                                    <div className="col-md-12">
                                        <div className="mb-3">
                                            ...
                                            <span className='text-danger'>{inspectionLook.error}</span>
                                        </div>
...
export default AddInspectionLook;