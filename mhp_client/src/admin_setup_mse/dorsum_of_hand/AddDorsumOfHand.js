...
const AddDorsumOfHand = () => {
    ...
    const SubmitDorsumOfHand = (e) => {
        // alert("dorsumOfHand")
        e.preventDefault();
        axios.post("/add-dorsum-of-hand",dorsumOfHand)
        .then(res=>{
            if (res.data.status == 200) {
                ...
                setDorsumOfHand({...dorsumOfHand,error:res.data.message.name[0]})
            }
        })
    }
    return (
                ...
                <div className="col-md-9 mt-3">
                    <div className="card">
                        <div className="card-header">
                            <h6 className="card-title"> Add Dorsum of Hand
                                <Link to={'/dorsum-of-hand'} className="btn btn-primary btn-sm float-end"> Back </Link>
                            </h6>
                        </div>
                        <div className="card-body">
                            <form id="DorsumOfHandForm" onSubmit={SubmitDorsumOfHand}>
                                <div className="card-body">
                                    ...
                                    <div className="col-md-12">
                                        <div className="mb-3">
                                            ...
                                            <span className='text-danger'>{dorsumOfHand.error}</span>
                                        </div>
...
export default AddDorsumOfHand;