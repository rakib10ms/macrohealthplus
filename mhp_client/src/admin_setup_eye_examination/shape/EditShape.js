...
function EditShape(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-shape/${lastpart}`).then(res => {

            if (res.data.status === 200) {
                console.log(res.data);
                setShape(res.data.Shape);
                // setPicture(res.data.Shape.image);
    ...
    const updateShapeInput = (e) => {
        ...
        axios.post(`/update-shape/${lastpart}`, formData).then(res => {
            if (res.data.status === 200) {
                    ...
                    <div className="col-md-9 mt-3">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <form id="ShapeForm" onSubmit={updateShapeInput}>
                                    <div className="card-body">
                                        ...
                                        <div className="col-md-12">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <span className="text-danger">{error.Shape_name}</span>
                                            </div>
