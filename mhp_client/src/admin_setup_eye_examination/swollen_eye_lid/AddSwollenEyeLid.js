...
function AddSwollenEyeLid() {
    ...
    const handleInput = (e) => {
        setSwollenEyeLid({
            ...SwollenEyeLid, [e.target.name]: e.target.value
        });
    }
    ...
    const submitSwollenEyeLid = (e) => {
        // alert("hgfdhgf")
        e.preventDefault();
  console.log(e)
        axios.post(`/save-swollen-eye-lid`, formData).then(res => {
            if (res.data.status == 200) {
                ...
                setSwollenEyeLid({ ...SwollenEyeLid, error_list: res.data.errors });
                        ...
                        <div className="col-md-9 mt-3">
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="card-title"> Add Swollen Eye Lid
                                        <Link to={'/swollen-eye-lid'} className="btn btn-primary btn-sm float-end"> Back </Link>
                                    </h6>
                                </div>
                                <div className="card-body">
                                    <form id="SwollenEyeLidForm" onSubmit={submitSwollenEyeLid}>
                                        <div className="card-body">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <span className="text-danger">{SwollenEyeLid.error_list.SwollenEyeLid_name}</span>
...
export default AddSwollenEyeLid;
