...
function EditLesion(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-lesion/${lastpart}`).then(res => {

            if (res.data.status === 200) {
                console.log(res.data);
                setLesion(res.data.Lesion);
                // setPicture(res.data.Lesion.image);
    ...
    const updateLesionInput = (e) => {
        ...
        axios.post(`/update-lesion/${lastpart}`, formData).then(res => {
            if (res.data.status === 200) {
                    ...
                    <div className="col-md-9 mt-3">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <form id="LesionForm" onSubmit={updateLesionInput}>
                                    <div className="card-body">
                                        ...
                                        <div className="col-md-12">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <span className="text-danger">{error.Lesion_name}</span>
                                            </div>
