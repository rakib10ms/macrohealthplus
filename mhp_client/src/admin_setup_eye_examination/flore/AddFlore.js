...
function AddFlore() {
    ...
    const handleInput = (e) => {
        setFlore({
            ...Flore, [e.target.name]: e.target.value
        });
    }
    ...
    const submitFlore = (e) => {
        ...
        e.preventDefault();
  console.log(e)
        axios.post(`/save-flore`, formData).then(res => {
            if (res.data.status == 200) {
                ...
                setFlore({ ...Flore, error_list: res.data.errors });
                        ...
                        <div className="col-md-9 mt-3">
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="card-title"> Add Flore
                                        <Link to={'/flore'} className="btn btn-primary btn-sm float-end"> Back </Link>
                                    </h6>
                                </div>
                                <div className="card-body">
                                    <form id="FloreForm" onSubmit={submitFlore}>
                                        <div className="card-body">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <span className="text-danger">{Flore.error_list.Flore_name}</span>
