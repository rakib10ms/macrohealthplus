...
class EditAppointmentLength extends Component {
    ...
    async componentDidMount() {
        ...
        const res = await axios.get(`/edit-appointment-lengths/${lastpart}`);
        // console.log(res);
        if (res.data.status === 200) {
            this.setState({
                appointment_lengths_name: res.data.appointment_lengths.appointment_lengths_name,
            });
    ...
    updateAppointmentLength = async (e) => {
        ...
        const res = await axios.put(`/update-appointment-lengths/${lastpart}`, this.state);
        ...
        if (res.data.status === 200) {
            ...
            // document.getElementById('update_btn').innerText = "Update appointment_lengths";
                        ...
                        <div className="col-md-9 mt-3">
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="card-title">Edit Appointment Lengths
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="form-group">
                                                    <label htmlFor="appointment_lengths_name" className="col-form-label-sm">Appointment Lengths</label>
