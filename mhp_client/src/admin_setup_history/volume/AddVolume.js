...
function AddVolume() {
    ...
    const handleInput=(e)=>{
       setvolume({
           ...volume,[e.target.name]:e.target.value
       });
    }
    ...
    const submitvolume=(e)=>{     
        ...
        const data={
            volume_name:volume.volume_name,
             status_id:volume.status_id,
            selection_criteria:volume.selection_criteria,
        }
    
        axios.post(`/save-volume`,data).then(res=>{
            if(res.data.status==200){
               ...
               setvolume({
                ...
                setvolume({ ...volume, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add Volume
                        <Link to={'/volume'} className="btn btn-primary btn-sm float-end"> Back </Link>
                    </h6>
                </div>
                <div className="card-body">
                    <form id="volumeForm" onSubmit={submitvolume}>
                        <div className="card-body">
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{volume.error_list.volume_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={volume.status_id} name="status_id"
                            ...
                            <span className="text-danger">{volume.error_list.status_id}</span>
         ...
         <div className='form-group mt-3'>
            ...
            <span className="text-danger">{volume.error_list.selection_criteria}</span>
