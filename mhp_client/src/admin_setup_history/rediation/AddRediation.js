...
function AddRediation() {
    ...
    const handleInput=(e)=>{
       setrediation({
           ...rediation,[e.target.name]:e.target.value
       });
    }

    const submitrediation=(e)=>{     
        e.preventDefault();
        const data={
            rediation_name:rediation.rediation_name,
             status_id:rediation.status_id,
            selection_criteria:rediation.selection_criteria,
        }
    
        axios.post(`/save-rediation`,data).then(res=>{
            if(res.data.status==200){
               ...
               setrediation({
                ...
                setrediation({ ...rediation, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add Rediation
                        <Link to={'/rediation'} className="btn btn-primary btn-sm float-end"> Back </Link>
                    </h6>
                </div>
                <div className="card-body">
                    <form id="rediationForm" onSubmit={submitrediation}>
                        <div className="card-body">
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{rediation.error_list.rediation_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={rediation.status_id} name="status_id"
                            ...
                            <span className="text-danger">{rediation.error_list.status_id}</span>
         ...
         <div className='form-group mt-3'>
            ...
            <span className="text-danger">{rediation.error_list.selection_criteria}</span>
