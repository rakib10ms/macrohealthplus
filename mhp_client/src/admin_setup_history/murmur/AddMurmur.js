...
function AddMurmur() {
    ...
    const handleInput=(e)=>{
       setmurmur({
           ...murmur,[e.target.name]:e.target.value
       });
    }

    const submitmurmur=(e)=>{     
        e.preventDefault();
        const data={
            murmur_name:murmur.murmur_name,
             status_id:murmur.status_id,
            selection_criteria:murmur.selection_criteria,
        }
    
        axios.post(`/save-murmur`,data).then(res=>{
            if(res.data.status==200){
               ...
               setmurmur({
                ...
                setmurmur({ ...murmur, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add Murmur
                        <Link to={'/murmur'} className="btn btn-primary btn-sm float-end"> Back </Link>
                    </h6>
                </div>
                <div className="card-body">
                    <form id="murmurForm" onSubmit={submitmurmur}>
                        <div className="card-body">
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{murmur.error_list.murmur_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={murmur.status_id} name="status_id"
                            ...
                            <span className="text-danger">{murmur.error_list.status_id}</span>
         ...
         <div className='form-group mt-3'>
            ...
            <span className="text-danger">{murmur.error_list.selection_criteria}</span>
