...
function EditContinuous(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-continuous/${lastpart}`).then(res => {

            if (res.data.status === 200) {
                // console.log(res.data.Continuous);
                setContinuous(res.data.Continuous);
                // setPicture(res.data.Continuous.image);
    ...
    const handleInput = (e) => {
        e.persist();
        setContinuous({ ...Continuous, [e.target.name]: e.target.value });
    }

    const updateContinuousInput = (e) => {
        e.preventDefault();
        ...
        axios.post(`/update-continuous/${lastpart}`, formData).then(res => {
            if (res.data.status === 200) {
                    ...
                    <div className="col-md-9 mt-3">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <form id="ContinuousForm" onSubmit={updateContinuousInput}>
                                    <div className="card-body">
                                        ...
                                        <div className="col-md-12">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <span className="text-danger">{error.Continuous_name}</span>
                                            </div>
