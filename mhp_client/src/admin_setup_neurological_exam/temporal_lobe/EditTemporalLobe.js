...
function EditTemporalLobe(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-temporal-lobe/${lastpart}`).then(res => {

            if (res.data.status === 200) {
                console.log(res.data);
                setTemporalLobe(res.data.TemporalLobe);
                // setPicture(res.data.TemporalLobe.image);
    ...
    const handleInput = (e) => {
        e.persist();
        setTemporalLobe({ ...TemporalLobe, [e.target.name]: e.target.value });
    }

    const updateTemporalLobeInput = (e) => {
        e.preventDefault();
        ...
        axios.post(`/update-temporal-lobe/${lastpart}`, formData).then(res => {
            if (res.data.status === 200) {
                    ...
                    <div className="col-md-9 mt-3">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <form id="TemporalLobeForm" onSubmit={updateTemporalLobeInput}>
                                    <div className="card-body">
                                        ...
                                        <div className="col-md-12">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <span className="text-danger">{error.TemporalLobe_name}</span>
                                            </div>
...
export default EditTemporalLobe;
