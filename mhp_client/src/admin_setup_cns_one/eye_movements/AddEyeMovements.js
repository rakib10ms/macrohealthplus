...
function AddEyeMovements() {
    ...
    const handleInput=(e)=>{
       seteyemovements({
           ...eyemovements,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal=(e)=>{     
        e.preventDefault();
        const data={
           eyemovements_name:eyemovements.eyemovements_name,
            status_id:eyemovements.status_id,
            selection_criteria:eyemovements.selection_criteria,
        }
    
        axios.post(`/save-eyemovements`,data).then(res=>{
            if(res.data.status==200){
               ...
               eyemovements_name:"",
                ...
                seteyemovements({ ...eyemovements, error_list: res.data.errors });
    ...
    <div className="container">
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{eyemovements.error_list.eyemovements_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={eyemovements.status_id} name="status_id"
                            ...
                            <span className="text-danger">{eyemovements.error_list.status_id}</span>
            ...
            <span className="text-danger">{eyemovements.error_list.selection_criteria}</span>
...
export default AddEyeMovements
