...
function AddFundosCopy() {
    ...
    const handleInput=(e)=>{
       setfundoscopy({
           ...fundoscopy,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal=(e)=>{     
        e.preventDefault();
        const data={
           fundoscopy_name:fundoscopy.fundoscopy_name,
            status_id:fundoscopy.status_id,
            selection_criteria:fundoscopy.selection_criteria,
        }
    
        axios.post(`/save-fundoscopy`,data).then(res=>{
            if(res.data.status==200){
               ...
               fundoscopy_name:"",
                ...
                setfundoscopy({ ...fundoscopy, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add Fundoscopy
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{fundoscopy.error_list.fundoscopy_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={fundoscopy.status_id} name="status_id"
                            ...
                            <span className="text-danger">{fundoscopy.error_list.status_id}</span>
            ...
            <span className="text-danger">{fundoscopy.error_list.selection_criteria}</span>
