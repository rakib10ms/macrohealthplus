...
function AddHallpike() {
    ...
    const handleInput=(e)=>{
       sethallpike({
           ...hallpike,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal=(e)=>{     
        e.preventDefault();
        const data={
           hallpike_name:hallpike.hallpike_name,
            status_id:hallpike.status_id,
            selection_criteria:hallpike.selection_criteria,
        }
    
        axios.post(`/save-hallpike`,data).then(res=>{
            if(res.data.status==200){
               ...
               hallpike_name:"",
                ...
                sethallpike({ ...hallpike, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add hallpike
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{hallpike.error_list.hallpike_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={hallpike.status_id} name="status_id"
                            ...
                            <span className="text-danger">{hallpike.error_list.status_id}</span>
            ...
            <span className="text-danger">{hallpike.error_list.selection_criteria}</span>
