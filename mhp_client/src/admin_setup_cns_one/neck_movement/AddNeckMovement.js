...
function AddNeckMovement() {
    ...
    const handleInput=(e)=>{
       setneckmovement({
           ...neckmovement,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal=(e)=>{     
        e.preventDefault();
        const data={
           neckmovement_name:neckmovement.neckmovement_name,
            status_id:neckmovement.status_id,
            selection_criteria:neckmovement.selection_criteria,
        }
    
        axios.post(`/save-neckmovement`,data).then(res=>{
            if(res.data.status==200){
               ...
               neckmovement_name:"",
                ...
                setneckmovement({ ...neckmovement, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add Neck movement
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{neckmovement.error_list.neckmovement_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={neckmovement.status_id} name="status_id"
                            ...
                            <span className="text-danger">{neckmovement.error_list.status_id}</span>
            ...
            <span className="text-danger">{neckmovement.error_list.selection_criteria}</span>
...
export default AddNeckMovement
