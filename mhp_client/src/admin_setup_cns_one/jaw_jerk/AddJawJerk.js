...
function AddJawJerk() {
    ...
    const handleInput=(e)=>{
       setjawjerk({
           ...jawjerk,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal=(e)=>{     
        e.preventDefault();
        const data={
           jawjerk_name:jawjerk.jawjerk_name,
            status_id:jawjerk.status_id,
            selection_criteria:jawjerk.selection_criteria,
        }
    
        axios.post(`/save-jawjerk`,data).then(res=>{
            if(res.data.status==200){
               ...
               jawjerk_name:"",
                ...
                setjawjerk({ ...jawjerk, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add jawjerk
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{jawjerk.error_list.jawjerk_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={jawjerk.status_id} name="status_id"
                            ...
                            <span className="text-danger">{jawjerk.error_list.status_id}</span>
            ...
            <span className="text-danger">{jawjerk.error_list.selection_criteria}</span>
