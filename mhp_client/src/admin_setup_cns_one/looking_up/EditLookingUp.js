...
function EditLookingUp(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-lookingup/${lastpart}`).then(res => {
    ...
    const handleInput = (e) => {
        e.persist();
        setlookingup({ ...lookingup, [e.target.name]: e.target.value });
    }
    ...
    const updateCanalInput= (e) => {
        ...
        const data = lookingup;
        axios.post(`/update-lookingup/${lastpart}`, data).then(res => {
            if (res.data.status === 200) {
        ...
        <div className="row">
            ...
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Edit lookingup
                ...
                <div className="card-body">
                    ...
                    <div className="col-md-12">
                        ...
                        <div className="form-group">
                            ...
                            <span className="text-danger">{error.lookingup_name}</span>
                ...
                <div className='form-group mt-3'>
                    ...
                    <div class="form-check form-check-inline ">
                        <input className="form-check-input mt-1" type="radio"onChange={handleInput} value="single" checked={lookingup.selection_criteria=='single'?true:''} name="selection_criteria"  id="inlineRadio1"/>
                        <label className="form-check-label" for="inlineRadio1"> <span style={{marginLeft:"-28px"}}>Single </span></label>
                        </div>
                        <div className="form-check form-check-inline">
                        <input className="form-check-input mt-1" type="radio" onChange={handleInput} name="selection_criteria" value="multiple" checked={lookingup.selection_criteria=='multiple'?true:''}  id="inlineRadio2"/>
