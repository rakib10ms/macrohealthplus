...
function AddSensation() {
    ...
    const handleInput=(e)=>{
       setsensation({
           ...sensation,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal=(e)=>{     
        e.preventDefault();
        const data={
           sensation_name:sensation.sensation_name,
            status_id:sensation.status_id,
            selection_criteria:sensation.selection_criteria,
        }
    
        axios.post(`/save-sensation`,data).then(res=>{
            if(res.data.status==200){
               ...
               sensation_name:"",
                ...
                setsensation({ ...sensation, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add Sensation
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{sensation.error_list.sensation_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={sensation.status_id} name="status_id"
                            ...
                            <span className="text-danger">{sensation.error_list.status_id}</span>
            ...
            <span className="text-danger">{sensation.error_list.selection_criteria}</span>
