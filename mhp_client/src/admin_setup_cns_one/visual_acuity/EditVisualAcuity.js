...
function  EditVisualAcuity(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-visualacuity/${lastpart}`).then(res => {
            console.log(res.data);
            if (res.data.status === 200) {
                setvisualacuity(res.data.visualacuity);
    ...
    const handleInput = (e) => {
        e.persist();
        setvisualacuity({ ...visualacuity, [e.target.name]: e.target.value });
    }
    ...
    const updateCanalInput= (e) => {
        ...
        axios.post(`/update-visualacuity/${lastpart}`, data).then(res => {
            if (res.data.status === 200) {
        ...
        <div className="row">
            ...
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Edit Visual Acuity
                ...
                <div className="card-body">
                    ...
                    <div className="col-md-12">
                        ...
                        <div className="form-group">
                            ...
                            <span className="text-danger">{error.visualacuity_name}</span>
                ...
                <div className='form-group mt-3'>
                    ...
                    <div class="form-check form-check-inline ">
                        <input className="form-check-input mt-1" type="radio"onChange={handleInput} value="single" checked={visualacuity.selection_criteria=='single'?true:''} name="selection_criteria"  id="inlineRadio1"/>
                        <label className="form-check-label" for="inlineRadio1"> <span style={{marginLeft:"-28px"}}>Single </span></label>
                        </div>
                        <div className="form-check form-check-inline">
                        <input className="form-check-input mt-1" type="radio" onChange={handleInput} name="selection_criteria" value="multiple" checked={visualacuity.selection_criteria=='multiple'?true:''}  id="inlineRadio2"/>
