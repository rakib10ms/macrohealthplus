...
function AddUvula() {
    ...
    const handleInput=(e)=>{
       setuvula({
           ...uvula,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal=(e)=>{     
        e.preventDefault();
        const data={
           uvula_name:uvula.uvula_name,
            status_id:uvula.status_id,
            selection_criteria:uvula.selection_criteria,
        }
    
        axios.post(`/save-uvula`,data).then(res=>{
            if(res.data.status==200){
               ...
               uvula_name:"",
                ...
                setuvula({ ...uvula, error_list: res.data.errors });
    ...
    <div className="container">
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{uvula.error_list.uvula_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={uvula.status_id} name="status_id"
                            ...
                            <span className="text-danger">{uvula.error_list.status_id}</span>
            ...
            <span className="text-danger">{uvula.error_list.selection_criteria}</span>
