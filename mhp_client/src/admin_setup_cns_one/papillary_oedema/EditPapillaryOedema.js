...
function  EditPapillaryOedema(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-papillaryoedema/${lastpart}`).then(res => {
            console.log(res.data);
            if (res.data.status === 200) {
                setpapillaryoedema(res.data.papillaryoedema);
    ...
    const handleInput = (e) => {
        e.persist();
        setpapillaryoedema({ ...papillaryoedema, [e.target.name]: e.target.value });
    }
    ...
    const updateCanalInput= (e) => {
        ...
        const data = papillaryoedema;
        axios.post(`/update-papillaryoedema/${lastpart}`, data).then(res => {
            if (res.data.status === 200) {
        ...
        <div className="row">
            ...
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Edit Papillary Oedema
                ...
                <div className="card-body">
                    ...
                    <div className="col-md-12">
                        ...
                        <div className="form-group">
                            ...
                            <span className="text-danger">{error.papillaryoedema_name}</span>
                ...
                <div className='form-group mt-3'>
                    ...
                    <div class="form-check form-check-inline ">
                        <input className="form-check-input mt-1" type="radio"onChange={handleInput} value="single" checked={papillaryoedema.selection_criteria=='single'?true:''} name="selection_criteria"  id="inlineRadio1"/>
                        <label className="form-check-label" for="inlineRadio1"> <span style={{marginLeft:"-28px"}}>Single </span></label>
                        </div>
                        <div className="form-check form-check-inline">
                        <input className="form-check-input mt-1" type="radio" onChange={handleInput} name="selection_criteria" value="multiple" checked={papillaryoedema.selection_criteria=='multiple'?true:''}  id="inlineRadio2"/>
...
export default EditPapillaryOedema
