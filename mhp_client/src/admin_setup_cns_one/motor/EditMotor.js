...
function EditMotor(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-motor/${lastpart}`).then(res => {

            if (res.data.status === 200) {
                console.log(res.data);
                setmotor(res.data.motor);
                // setPicture(res.data.motor.image);
    ...
    const updateMotorInput = (e) => {
        ...
        axios.post(`/update-motor/${lastpart}`, formData).then(res => {
            if (res.data.status === 200) {
                    ...
                    <div className="col-md-9 mt-3">
                        <div className="card">
                            <div className="card-header">
                                <h6 className="card-title"> Edit Motor
                                    <Link to={'/motor'} className="btn btn-primary btn-sm float-end"> Back </Link>
                                </h6>
                            </div>
                            <div className="card-body">
                                <form id="MotorForm" onSubmit={updateMotorInput}>
                                    <div className="card-body">
                                        ...
                                        <div className="col-md-12">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <span className="text-danger">{error.motor_name}</span>
                                            </div>
