...
function AddWhisperTest() {
    ...
    const handleInput=(e)=>{
       setwhispertest({
           ...whispertest,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal=(e)=>{     
        e.preventDefault();
        const data={
           whispertest_name:whispertest.whispertest_name,
            status_id:whispertest.status_id,
            selection_criteria:whispertest.selection_criteria,
        }
    
        axios.post(`/save-whispertest`,data).then(res=>{
            if(res.data.status==200){
               ...
               whispertest_name:"",
                ...
                setwhispertest({ ...whispertest, error_list: res.data.errors });
    ...
    <div className="container">
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{whispertest.error_list.whispertest_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={whispertest.status_id} name="status_id"
                            ...
                            <span className="text-danger">{whispertest.error_list.status_id}</span>
            ...
            <span className="text-danger">{whispertest.error_list.selection_criteria}</span>
