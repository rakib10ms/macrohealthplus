...
function AddPinnesTest() {
    ...
    const handleInput=(e)=>{
       setpinnestest({
           ...pinnestest,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal=(e)=>{     
        e.preventDefault();
        const data={
           pinnestest_name:pinnestest.pinnestest_name,
            status_id:pinnestest.status_id,
            selection_criteria:pinnestest.selection_criteria,
        }
    
        axios.post(`/save-pinnestest`,data).then(res=>{
            if(res.data.status==200){
               ...
               pinnestest_name:"",
                ...
                setpinnestest({ ...pinnestest, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add pinne's Test
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{pinnestest.error_list.pinnestest_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={pinnestest.status_id} name="status_id"
                            ...
                            <span className="text-danger">{pinnestest.error_list.status_id}</span>
            ...
            <span className="text-danger">{pinnestest.error_list.selection_criteria}</span>
