...
function AddPupil() {
    ...
    const handleInput=(e)=>{
       setpupil({
           ...pupil,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal=(e)=>{     
        ...
        const data={
           pupil_name:pupil.pupil_name,
            status_id:pupil.status_id,
            selection_criteria:pupil.selection_criteria,
        }
    
        axios.post(`/save-pupil`,data).then(res=>{
            if(res.data.status==200){
               ...
               pupil_name:"",
                ...
                setpupil({ ...pupil, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add Pupil
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{pupil.error_list.pupil_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={pupil.status_id} name="status_id"
                            ...
                            <span className="text-danger">{pupil.error_list.status_id}</span>
            ...
            <span className="text-danger">{pupil.error_list.selection_criteria}</span>
