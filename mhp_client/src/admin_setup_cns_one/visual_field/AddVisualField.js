...
function AddVisualField() {
    ...
    const handleInput=(e)=>{
       setvisualfield({
           ...visualfield,[e.target.name]:e.target.value
       });
    }
    ...
    const submitCanal=(e)=>{     
        e.preventDefault();
        const data={
           visualfield_name:visualfield.visualfield_name,
            status_id:visualfield.status_id,
            selection_criteria:visualfield.selection_criteria,
        }
    
        axios.post(`/save-visualfield`,data).then(res=>{
            if(res.data.status==200){
               ...
               visualfield_name:"",
                ...
                setvisualfield({ ...visualfield, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add Visual Field
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{visualfield.error_list.visualfield_name}</span>
                    ...
                    <div>
                        ...
                        <select id="inputState" onChange={handleInput} value={visualfield.status_id} name="status_id"
                            ...
                            <span className="text-danger">{visualfield.error_list.status_id}</span>
            ...
            <span className="text-danger">{visualfield.error_list.selection_criteria}</span>
