...
function EditServices(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-services-name/${lastpart}`).then(res => {

            if (res.data.status === 200) {
                console.log(res.data);
                setservices(res.data.service);
                // setPicture(res.data.services.image);
    ...
    const updateservicesInput = (e) => {
        ...
        axios.post(`/update-services-name/${lastpart}`, services).then(res => {
            if (res.data.status === 200) {
                    ...
                    <div className="col-md-9 mt-3">
                        <div className="card">
                            <div className="card-header">
                                <h6 className="card-title"> Edit Services/Faciliies Name
                                    <Link to={'/care-suggestion'} className="btn btn-primary btn-sm float-end"> Back </Link>
                                </h6>
                            </div>
                            <div className="card-body">
                                <form id="servicesForm" onSubmit={updateservicesInput}>
                                    <div className="card-body">
