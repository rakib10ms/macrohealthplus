...
function PaediatricPage15(props) {
    console.log('props data check 15 no page', props)
    ...
    const [bleedingGum, setbleedingGum] = useState("");
    ...
    const [oralhealth1, setOralhealth1] = useState(false);
    ...
    const handleSave = (e) => {
        e.preventDefault();
        console.log('state check', TwelveMonthsHealthCheck);
        ...
        axios.post(`/save-paediatric-twelve-months-health-check`, TwelveMonthsHealthCheck).then(res => {
    ...
    return (
        <div className='bg-white py-3 px-5 rounded-3' style={{ overflowX: 'none' }}>
            <div className=''>
                <h5 className='pb-1'><b>The 12 months health check:  </b> </h5>
            </div>
                                        ...
                                        >
                                            ...
                                            <div className="text-box" style={{ width: "90px", padding: "4px", boxShadow: "none" }}>
                                                ...
                                                <div className="d-flex">
                                                    <input className="form-control" value={weight} type="text" name="weight" onChange={(e) => { setWeight(e.target.value) }} id="exampleCheck1" />
            ...
            <div className='shadow-lg py-2 mt-2 bg-body rounded p-3'>
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange8(!change8); setOralhealth("") }}
                                            id="togBtn"
                                        />
                                        <div onClick={(e) => setAnchorEl8(e.currentTarget)} className="slider round"></div>
                                        {
                                            ...
                                            >
                                                ...
                                                <div className="left-popup">
                                                    <div className="form-check ms-1">
                                                        <input className="form-check-input" value="normal" type="radio" name="oral_health" onChange={(e) => { setOralhealth(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            Normal
                                                        </label>
                                                        <input className="form-check-input" value="review" type="radio" name="oral_health" onChange={(e) => { setOralhealth(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            Review
                                                        </label>
                                                        <input className="form-check-input" value="after" type="radio" name="oral_health" onChange={(e) => { setOralhealth(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            After
                                                        </label>
                                                    </div>
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange9(!change9); setVisiblePlaque("") }}
                                            id="togBtn"
                                        />
                ...
                <div className="row mt-2">
                    ...
                    <div className="col-4">
                        <div className="paediatric_last_twelve pt-2">
                            <div className="d-flex justify-content-around">
                                <p className="w-75">Bleeding gums</p>
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            name="Jaundiced"
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange10(!change10); setbleedingGum("") }}
                                            id="togBtn"
                                        />
                                        <div onClick={(e) => setAnchorEl10(e.currentTarget)} className="slider round"></div>
                                        {
                                            ...
                                            >
                                                ...
                                                <div className="left-popup">
                                                    <div className="form-check ms-1">
                                                        <input className="form-check-input" value="normal" type="radio" name="bleeding_gum" onChange={(e) => { setbleedingGum(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            Normal
                                                        </label>
                                                        <input className="form-check-input" value="review" type="radio" name="bleeding_gum" onChange={(e) => { setbleedingGum(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            Review
                                                        </label>
                                                        <input className="form-check-input" value="after" type="radio" name="bleeding_gum" onChange={(e) => { setbleedingGum(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            After
                                                        </label>
                                                    </div>
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange11(!change11); setwhiteSpot("") }}
                                            id="togBtn"
                                        />
                ...
                <div className="row mt-4">
                    ...
                    <div className="col-4">
                        <div className="paediatric_last_twelve pt-2">
                            <div className="d-flex justify-content-around">
                                <p className="w-75">Evaluate gait (if walking) </p>
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            name="Jaundiced"
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange12(!change12); setEvaluateGait("") }}
                                            id="togBtn"
                                        />
                                        <div onClick={(e) => setAnchorEl12(e.currentTarget)} className="slider round"></div>
                                        {
                                            ...
                                            >
                                                ...
                                                <div className="left-popup ">
                                                    <div className="form-check ms-1">
                                                        <input className="form-check-input" value="yes" type="radio" name="evaluate_gait" onChange={(e) => { setEvaluateGait(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            Yes
                                                        </label>
                                                        <input className="form-check-input" value="no" type="radio" name="evaluate_gait" onChange={(e) => { setEvaluateGait(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            No
                                                        </label>
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange13(!change13); setfullyDescended(""); setfullyDescendedValue('') }}
                                            id="togBtn"
                                        />
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange14(!change14); setParentQtn("") }}
                                            id="togBtn"
                                        />
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange15(!change15); setAgeAppropriate("") }}
                                            id="togBtn"
                                        />
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange16(!change16); setHearing("") }}
                                            id="togBtn"
                                        />
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange17(!change17); setVision("") }}
                                            id="togBtn"
                                        />
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange18(!change18); sethips("") }}
                                            id="togBtn"
                                        />
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            type="checkbox"
                                            onChange={(e) => {
                                                setChange19(!change19); setOralhealth1(false);
                                                if (e.target.checked) {
                                                    setOralhealth1(true)
                                                }
                                                else {
                                                    setOralhealth1(false)
                                                }
                                            }}
                                            id="togBtn"
                                        />
...
export default PaediatricPage15;