...
toast.configure();
function PaediatricPage17(props) {


    const [weight, setWeight] = useState("");
    const [height, setHeight] = useState("");
    const [evaluateGait, setEvaluateGait] = useState('');
    const [eyesObservation, setEyesObservation] = useState('');
    ...
    const [oralHealth, setOralHealth] = useState(false);
    console.log('oral Health check', oralHealth)
    ...
    const EightenMonthsHealthCheck = {
        weight: weight,
        height: height,
        ...
        hearing: hearing,
        vision: vision,
        oral_health_lip: oralHealth,
        oral_health: oralhealth1,
        outcome: outcome,
        comments: comment,
        bleeding_gum: bleeding,
        evaluate_gait: evaluateGait,
        eye_observation:eyesObservation,
    ...
    const handleSave = (e) => {
        e.preventDefault();
        console.log('state check', EightenMonthsHealthCheck);
        ...
        axios.post(`/save-paediatric-eighteen-months-health-check`, EightenMonthsHealthCheck).then(res => {
    ...
    return (
        <div className='bg-white py-3 px-5 rounded-3' style={{ overflowX: 'none' }}>
            <div className=''>
                <h5 className='pb-1'><b>The 18 months health check </b> </h5>
            </div>
            ...
            <div className='shadow-lg py-2 mt-2 bg-body rounded p-3'>
                <div className="row ">
                    <div className="col-4">
                        <div className="paediatric_last_twelve pt-2">
                            <div className="d-flex justify-content-around">
                                <p className="w-75">Evaluate gait </p>
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            name="Jaundiced"
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange3(!change3); setEvaluateGait("") }}
                                            id="togBtn"
                                        />
                                            ...
                                            >
                                                ...
                                                <div className="left-popup">
                                                    <div className="form-check ms-1">
                                                        <input className="form-check-input" value="normal" type="radio" name="evaluate" onChange={(e) => { setEvaluateGait(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            Normal
                                                        </label>
                                                        <input className="form-check-input" value="review" type="radio" name="evaluate" onChange={(e) => { setEvaluateGait(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            Review
                                                        </label>
                                                        <input className="form-check-input" value="after" type="radio" name="evaluate" onChange={(e) => { setEvaluateGait(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            After
                                                        </label>
                                                    </div>
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange4(!change4); setEyesObservation("") }}
                                            id="togBtn"
                                        />
                                        <div onClick={(e) => setAnchorEl4(e.currentTarget)} className="slider round"></div>
                                        {
                                            ...
                                            >
                                                ...
                                                <div className="left-popup">
                                                    <div className="form-check ms-1">
                                                        <input className="form-check-input" value="normal" type="radio" name="eye_observation" onChange={(e) => { setEyesObservation(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            Normal
                                                        </label>
                                                        <input className="form-check-input" value="review" type="radio" name="eye_observation" onChange={(e) => { setEyesObservation(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            Review
                                                        </label>
                                                        <input className="form-check-input" value="after" type="radio" name="eye_observation" onChange={(e) => { setEyesObservation(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            After
                                                        </label>
                                                    </div>
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange7(!change7); setOneEye("") }}
                                            id="togBtn"
                                        />
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange9(!change9); setOralHealth(!oralHealth) }}
                                            id="togBtn"
                                        />
            ...
            <div className='shadow-lg py-2 mt-2 bg-body rounded '>
                <div className="form-floating p-2">
                    <textarea className="form-control" value={comment} placeholder="Leave a comment here" id="floatingTextarea2" style={{ height: "100px" }} onChange={(e) => setComment(e.target.value)}>{comment}</textarea>
...
export default PaediatricPage17;