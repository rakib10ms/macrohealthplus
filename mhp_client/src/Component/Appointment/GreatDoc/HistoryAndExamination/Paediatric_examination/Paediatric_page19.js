...
toast.configure();
function PaediatricPage19(props) {

    const [age, setAge] = useState("");
    const [weight, setWeight] = useState("");
    const [height, setHeight] = useState("");
    const [eyeObservation, setEyeObservation] = useState("");

    const [corneal, setCorneal] = useState("");
    ...
    const [oralhealth1, setOralhealth1] = useState("");
    const [ageAppropriate, setAgeAppropriate] = useState("");
    const [oralhealthLips, setOralhealthLips] = useState(false);
    const [observerGait, setObserverGait] = useState("");
    ...
    const twoYearChildHealth = {
        ...
        hearing: hearing,
        vision: vision,
        oral_health_lip: oralhealthLips,
        oral_health: oralhealth1,
        outcome: outcome,
        comments: comment,
        bleeding_gum: bleeding,
        observer_gait:observerGait,
    ...
    const handleSave = (e) => {
        e.preventDefault();
        console.log('state check', twoYearChildHealth);
        ...
        axios.post(`/save-paediatric-two-years-child-health-check`, twoYearChildHealth).then(res => {
    ...
    return (
        <div className='bg-white py-3 px-5 rounded-3' style={{ overflowX: 'none' }}>
            <div className=''>
                <h5 className='pb-1'><b>The 2 years Child health check: </b> </h5>
            </div>
            <h6>Assessment by a child and family health nurse, GP or paediatrician.</h6>
                                        ...
                                        >
                                            ...
                                            <div className="text-box" style={{ width: "90px", padding: "4px", boxShadow: "none" }}>
                                                ...
                                                <div className="d-flex">
                                                    <input className="form-control" value={age} type="text" name="age" onChange={(e) => { setAge(e.target.value) }} id="exampleCheck1" />
            ...
            <div className='shadow-lg py-2 mt-2 bg-body rounded p-3'>
                <div className="row ">
                    <div className="col-4">
                        <div className="paediatric_last_twelve pt-2">
                            <div className="d-flex justify-content-around">
                                <p className="w-75">Observe gait  </p>
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            name="Jaundiced"
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange3(!change3); setObserverGait("") }}
                                            id="togBtn"
                                        />
                                            ...
                                            >
                                                ...
                                                <div className="left-popup">
                                                    <div className="form-check ms-1">
                                                        <input className="form-check-input" value="normal" type="radio" name="observer_gait" onChange={(e) => { setObserverGait(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            Normal
                                                        </label>
                                                        <input className="form-check-input" value="review" type="radio" name="observer_gait" onChange={(e) => { setObserverGait(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            Review
                                                        </label>
                                                        <input className="form-check-input" value="after" type="radio" name="observer_gait" onChange={(e) => { setObserverGait(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            After
                                                        </label>
                                                    </div>
                    ...
                    <div className="col-4">
                        <div className="paediatric_last_twelve pt-2">
                            <div className="d-flex justify-content-around">
                                <p className="w-75">Eyes Observation</p>
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            name="Jaundiced"
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange4(!change4); setEyeObservation("") }}
                                            id="togBtn"
                                        />
                                        <div onClick={(e) => setAnchorEl4(e.currentTarget)} className="slider round"></div>
                                        {
                                            ...
                                            >
                                                ...
                                                <div className="left-popup">
                                                    <div className="form-check ms-1">
                                                        <input className="form-check-input" value="normal" type="radio" name="eye_observation" onChange={(e) => { setEyeObservation(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            Normal
                                                        </label>
                                                        <input className="form-check-input" value="review" type="radio" name="eye_observation" onChange={(e) => { setEyeObservation(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            Review
                                                        </label>
                                                        <input className="form-check-input" value="after" type="radio" name="eye_observation" onChange={(e) => { setEyeObservation(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            After
                                                        </label>
                                                    </div>
                    ...
                    <div className="col-4">
                        <div className="paediatric_last_twelve pt-2">
                            <div className="d-flex justify-content-around">
                                <p className="w-75">Corneal light reflections </p>
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            name="Jaundiced"
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange5(!change5); setCornelLight("") }}
                                            id="togBtn"
                                        />
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange6(!change6); setFixation("") }}
                                            id="togBtn"
                                        />
                                            ...
                                            >
                                                ...
                                                <div className="left-popup">
                                                    <div className="form-check ms-1">
                                                        ...
                                                        <input className="form-check-input" value="review" type="radio" name="fixation" onChange={(e) => { setFixation(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            Review
                                                        </label>
                                                        <input className="form-check-input" value="after" type="radio" name="fixation" onChange={(e) => { setFixation(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            After
                                                        </label>
                                                    </div>
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange7(!change7); oneEye("") }}
                                            id="togBtn"
                                        />
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange8(!change8); setEyeMovement("") }}
                                            id="togBtn"
                                        />
                ...
                <div className="row mt-2">
                    ...
                    <div className="col-4">
                        <div className="paediatric_last_twelve pt-2">
                            <div className="d-flex justify-content-around">
                                <p className="w-75">Oral health (Lift the lip and check)</p>
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            name="Jaundiced"
                                            ...
                                            type="checkbox"
                                            onChange={(e) => {
                                                setChange9(!change9); setOralhealthLips(false);
                                                if (e.target.checked) {
                                                    setOralhealthLips(true)
                                                }
                                                else {
                                                    setOralhealthLips(false)
                                                }
                                            }}
                                            id="togBtn"
                                        />
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange10(!change10); setVisiblePlaque("") }}
                                            id="togBtn"
                                        />
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange11(!change11); setBleeding("") }}
                                            id="togBtn"
                                        />
                                            ...
                                            >
                                                ...
                                                <div className="left-popup">
                                                    <div className="form-check ms-1">
                                                        ...
                                                        <input className="form-check-input" value="after" type="radio" name="bleeding" onChange={(e) => { setBleeding(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            After
                                                        </label>
                                                    </div>
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange12(!change12); setwhiteSpot("") }}
                                            id="togBtn"
                                        />
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange17(!change17); setOralhealth1("") }}
                                            id="togBtn"
                                        />
                                        <div onClick={(e) => setAnchorEl17(e.currentTarget)} className="slider round"></div>
                                        {
                                            ...
                                            >
                                                ...
                                                <div className="left-popup">
                                                    <div className="form-check ms-1">
                                                        <input className="form-check-input" value="yes" type="radio" name="oral_health1" onChange={(e) => { setOralhealth1(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            Yes
                                                        </label>
                                                        <input className="form-check-input" value="no" type="radio" name="oral_health1" onChange={(e) => { setOralhealth1(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            No
                                                        </label>
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange18(!change18); setOutcome("") }}
                                            id="togBtn"
                                        />
            ...
            <div className='shadow-lg py-2 mt-2 bg-body rounded '>
                <div className="form-floating p-2">
                    <textarea className="form-control" value={comment} onChange={(e) => setComment(e.target.value)} name="comment"  placeholder="Leave a comment here" id="floatingTextarea2" style={{ height: "100px" }}>{comment}</textarea>
...
export default PaediatricPage19;