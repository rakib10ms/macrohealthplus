...
toast.configure();
function PaediatricPage21(props) {
    ...
    const handleSave=(e)=>{
        e.preventDefault();
        const threeYearChildHealth = {
            weight: weight,
            height: height,
            bmi:bmi,
            observer_gait:observerGait,
            eyes_observation:eyeObservation,
        ...
        console.log('state data check',threeYearChildHealth);
    ...
    return (
        <div className='bg-white py-3 px-5 rounded-3' style={{ overflowX: 'none' }}>
            <div className=''>
                <h5 className='pb-1'><b>The 3 years Child health check: </b> </h5>
            </div>
                                        ...
                                        >
                                            ...
                                            <div className="text-box" style={{ width: "90px", padding: "4px" }}>
                                                ...
                                                <div className="d-flex">
                                                    <input className="form-control" value={weight} type="text" name="cough1" onChange={(e) => { setWeight(e.target.value) }} id="exampleCheck1" />
            ...
            <div className='shadow-lg py-2 mt-3 bg-body rounded p-3'>
                <div className="row ">
                    <div className="col-4">
                        <div className="paediatric_last_twelve pt-2">
                            <div className="d-flex justify-content-around">
                                <p className="w-75">Observer gait </p>
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            name="Jaundiced"
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange4(!change4); setObserverGait("") }}
                                            id="togBtn"
                                        />
                                            ...
                                            >
                                                ...
                                                <div className="left-popup">
                                                    <div className="form-check ms-1">
                                                        <input className="form-check-input" value="normal" type="radio" name="evaluate" onChange={(e) => { setObserverGait(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            Normal
                                                        </label>
                                                        <input className="form-check-input" value="review" type="radio" name="evaluate" onChange={(e) => { setObserverGait(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            Review
                                                        </label>
                                                        <input className="form-check-input" value="after" type="radio" name="evaluate" onChange={(e) => { setObserverGait(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            After
                                                        </label>
                                                    </div>
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange5(!change5); setEyeObservation("") }}
                                            id="togBtn"
                                        />
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange6(!change6); setCornelLight("") }}
                                            id="togBtn"
                                        />
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange7(!change7); setFixation("") }}
                                            id="togBtn"
                                        />
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange8(!change8); setOneEye("") }}
                                            id="togBtn"
                                        />
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange9(!change9); setEyeMovement("") }}
                                            id="togBtn"
                                        />
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange10(!change10); setOralHealth("") }}
                                            id="togBtn"
                                        />
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange11(!change11); setVisiblePlaque("") }}
                                            id="togBtn"
                                        />
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange12(!change12); setBleeding("") }}
                                            id="togBtn"
                                        />
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            value="Jaundiced"
                                            type="checkbox"
                                            onChange={(e) => { setChange13(!change13); setwhiteSpot("") }}
                                            id="togBtn"
                                        />
...
export default PaediatricPage21;