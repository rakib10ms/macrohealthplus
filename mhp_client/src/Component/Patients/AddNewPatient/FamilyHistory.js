    ...
    return (
        <>
         <div className="mt-5 row family-history-container">
            ...
            <div className="mt-5">
                    <h3 className="mt-2">Family & Social History
                 <Link to={`/edit-patients/${lastpart}`} className="btn btn-primary btn-sm float-end"> Back </Link>
                            ...
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                <div className="card p-3">
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <input class="form-check-input check-box" type="checkbox" name="is_drinker" onChange={handleCheckbox} defaultChecked={allcheckbox.is_drinker === 1 ? true:false } />
                                        <label className="form-check-label col-form-label col-form-label-sm">Non Drinker</label>
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div className="card p-2">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div class="form-check mb-3">
                                            <input class="form-check-input" type="checkbox" name="is_fresho_leaf" onChange={handleInput} value={patientInput.is_fresho_leaf}/>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-check-input" type="checkbox" name="is_cessation_advice" onChange={handleInput} value={patientInput.is_cessation_advice}/>
