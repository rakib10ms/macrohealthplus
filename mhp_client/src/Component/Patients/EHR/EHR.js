...
import patient from '../../../Images/crush.jpg'
...
import doc from '../../../Images/crush.jpg';
import { Line } from "react-chartjs-2";
import { Chart as ChartJS } from "chart.js/auto";
const EHR = () => {
    const [activeDate, setActiveDate] = useState(new Date().getFullYear());
    const date = new Date().getFullYear();
    const add = 2017;
    let year = [];
    for (let i = add + 1; i <= date; i++) {
        year.push(i);
    }
    const dateTomap = year.reverse();
    ...
    const [userData, setUserData] = useState({
        ...
        datasets: [
            {
                label: "Heat Rate",
                data: chartData.map((data) => data.heartRate),
                backgroundColor: [
                    "rgba(75,192,192,1)",
                    "#ecf0f1",
                    "#50AF95",
    ...
    return (
        <div className='row ehr-container ms-2 mt-2'>
            <div className="custom-card flex-grow-1 mb-2">
                <h5 className="fw-normal  text-start py-2 px-1 mb-2 text-login">Patient Health Summary</h5>
            </div>
            <div className="col-2 custom-card">
                <div className=" p-3 ehr-left-sidebar">
                    <div className="ehr-paitent-section row">
                        <div className="col-6">
                            <img src={patient} alt="" />
                        </div>
                        <div className="col-6">
                            <h6 className="mt-2">Ruben Aminoff</h6>
                            <span className='me-2'>Male</span>
                            <span>26</span>
                        </div>
                    </div>
                    <div className="ehr-history-section mt-3">
                        <span>Social History</span>
                        <p>Alcohol, Tobacco</p>
                        <span>Care Plan</span>
                        <p>MHP Care Plan</p>
                        <span>Mejor Problems</span>
                        <p>Hyper Tension, Anaphylaxis, Atopic Dermatitis  </p>
                        <span>Reaction</span>
                        <p>Hyper Tension, Anaphylaxis, Atopic Dermatitis  </p>
                        <span>Allergy</span>
                        <p>Hyper Tension, Anaphylaxis, Atopic Dermatitis  </p>
                    </div>
                    <div className="ehr-history-tab-section">
                        <ul>
            ...
            <div className="col-10 ehr-history-container">
                <div className="row ehr-search custom-card ms-1 ">
                    <div className="col-4 ">
                        <h6>Overview</h6>
                    </div>
                    <div className="col-8">
                ...
                <div className="row ehr-indicator custom-card  mt-2 ms-1">
                    <div className="col-2">
                        <h6>Patient History</h6>
                    </div>
                    <div className="col-10">
                        <ul>
                            <li><i style={{ color: "#67CA7B" }} className="fas fa-circle me-1"></i>Visit</li>
                            <li><i style={{ color: "#D07369" }} className="fas fa-circle me-1"></i>Hospitalizations</li>
                            <li><i style={{ color: "#4EAC9B" }} className="fas fa-circle me-1"></i>Procedures</li>
                            <li><i style={{ color: "#F5CC7A" }} className="fas fa-circle me-1"></i>Medication</li>
                            <li><i style={{ color: "#4382D8" }} className="fas fa-circle me-1"></i>Labs</li>
                            <li><i style={{ color: "#8580BF" }} className="fas fa-circle me-1"></i>Imaging</li>
                        </ul>
                    </div>
                    <div className="ehr-table row">
                        <div className="col-10">
                            <table>
                                ...
                                <tr>
                                    <td><i style={{ color: "#67CA7B" }} className="fas fa-circle me-1"></i></td>
                                    <td><i style={{ color: "#D07369" }} className="fas fa-circle me-1"></i></td>
                                    <td><i style={{ color: "#4EAC9B" }} className="fas fa-circle me-1"></i></td>
                                    <td><i style={{ color: "#F5CC7A" }} className="fas fa-circle me-1"></i></td>
                                    <td><i style={{ color: "#4382D8" }} className="fas fa-circle me-1"></i></td>
                                    <td><i style={{ color: "#8580BF" }} className="fas fa-circle me-1"></i></td>
                                    <td><i style={{ color: "#67CA7B" }} className="fas fa-circle me-1"></i></td>
                                    <td><i style={{ color: "#D07369" }} className="fas fa-circle me-1"></i></td>
                                    <td><i style={{ color: "#4EAC9B" }} className="fas fa-circle me-1"></i></td>
                                    <td><i style={{ color: "#8580BF" }} className="fas fa-circle me-1"></i></td>
                ...
                <div className="row mt-2 ms-1">
                    <div className="col-6 ehr-anatomy">
                        <div className="row custom-card">
                            <h6 className="mb-2 mt-2">Diagnosis History</h6>
                            <div className="col-3 ehr-timeline">
                                <Timeline position="left">
                                    {dateTomap.map((item, i) => (
                                        <TimelineItem onClick={() => setActiveDate(item)} className={`${activeDate === item || activeDate - 1 === item ? 'active-time-line' : ""}`} key={i}>
                                            <TimelineSeparator>
                                                <TimelineDot />
                                                <TimelineConnector className={`${activeDate === item ? 'active-line-connector' : ""}`} />
                                            </TimelineSeparator>
                                            <TimelineContent className={`${activeDate === item || activeDate - 1 === item ? "active-year" : ""}`}>{item}</TimelineContent>
                                        </TimelineItem>
                                    ))}
                                    <TimelineItem className={`${activeDate <= add + 1 ? 'active-time-line' : ""}`}>
                                        <TimelineSeparator>
                                            <TimelineDot />
                                        </TimelineSeparator>
                                        <TimelineContent onClick={() => setActiveDate(add + 1)} className={`${activeDate <= add + 1 ? "active-year" : ""}`}>{add}</TimelineContent>
                                    </TimelineItem>
                                </Timeline>
                            </div>
                            <div className="col-5">
                            ...
                            <div className="col-4 ehr-anatomy-symptoms">
                                <input type="text" placeholder='Search' className="form-control form-control-sm" />
                                <ul className='mt-1'>
                                    <li onClick={() => { setShowNotes(false); setShowAllNotes(true) }}>All Symptoms</li>
                                    <li>Headache</li>
                                    <li>Face pain</li>
                                    <li>Fever</li>
                                    <li>Chest pain</li>
                    ...
                    <div className="col-6 ehr-history">
                        {
                            !showNotes && showAllNotes ?
                                <div className='custom-card h-100 p-1'>
                                    <span className='float-end' style={{ marginTop: "-5px", fontSize: "16px", cursor: "pointer" }} onClick={() => setShowAllNotes(false)}><i className="fal fa-times"></i></span>
                                    <h6 className="mb-1">Documents</h6>
                                    <div className="row">
                                        {
                                            documents.map((item, i) => <div key={i} className='col-4 mt-2'>
                                                <div onClick={() => { setShowNotes(true); setShowAllNotes(false) }} className="ehr-all-doucments-card p-2">
                                                    <div className="ehr-anatomy-header d-flex align-items-center">
                                                        <i style={{ backgroundColor: "#8CBB98", color: "#fff", fontSize: "25px" }} className="fad fa-file-alt me-4"></i><p>14/01</p>
                                                    </div>
                                                    <p className='ehr-documents-card-text mt-3'>Visit: {item.title}</p>
                                                    <div className="ehr-documents-card-doc d-flex aling-items-center">
                                                        <img src={item.img} className="me-1" alt="" />
                                                        <span className='mt-1'>{item.doctor}</span>
                                                    </div>
                                                </div>
                                            </div>)
                                        }
                                ...
                                : showNotes && !showAllNotes ?
                                    <div className='custom-card h-100 p-1'>
                                        <span className='float-end' style={{ marginTop: "-5px", fontSize: "16px", cursor: "pointer" }} onClick={() => { setShowNotes(false); setShowAllNotes(true) }}><i className="fal fa-times"></i></span>
                                        <div className="d-flex">
                                            <div>
                                                <i style={{ backgroundColor: "#8CBB98", color: "#fff", fontSize: "40px" }} className="fad fa-file-alt me-2"></i>
                                            </div>
                                            <div>
                                                <span>14/01/2020</span>
                                                <h6>Visit: Rotator Cuff injury</h6>
                                            </div>
                                        </div>
                                        <div className="d-flex justify-content-between ehr-popup-doc-section">
                                            <p className="ehr-doc-name"><img src={doc} alt="" className='me-2' />Dr. Nolan George</p>
                                            <p><i className="fal fa-map-marker-alt me-2"></i>The Alfred Melbourne, Australia</p>
                                        </div>
                                        <div className="ehr-popup-details">
                                            <p className="ehr-details-heading">Complaint: Arm weakness, disturb sleep</p>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nibh ultrices morbi mollis amet, mauris. Aliquet eros, rhoncus massa non phasellus interdum egestas. Eu tincidunt scelerisque etiam nec auctor donec placerat lectus. Sit nisi ultrices euismod gravida non placerat ultrices rutrum.</p>
                                            <p className="ehr-details-heading">Treatement</p>
                                            <p>Eu tincidunt scelerisque etiam nec auctor donec placerat lectus.</p>
                                            <p className="ehr-details-heading">Follow Up</p>
                                            <p>6 Months</p>
                                            <p className="ehr-details-heading">Assessments</p>
                                            <span>01. Lorem ipsum dolor sit amet</span>
                                            <span>02. Consectetur adipiscing elit</span>
                                            <p className="ehr-details-hei">Linked Documents</p>
                                            <div className="ehr-test-document">
                                                <a href='http://localhost/mhp_web/mhp_server/public/ehrReport/sample-report-1.pdf' download target="_blank"><i className="fad fa-file-alt me-2"></i> MRI Report<i className="far fa-cloud-download float-end me-2 mt-1"></i></a>
                                                <a href='http://localhost/mhp_web/mhp_server/public/ehrReport/sample-report-2.pdf' download target="_blank" className='mt-2'><i className="fad fa-file-alt me-2"></i> Neurology Report 2<i className="far fa-cloud-download float-end me-2 mt-1"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    :
                                    <div className='custom-card h-100 p-1'>
                                        ...
                                        <ul className="nav nav-pills mb-1" id="pills-tab" role="tablist">
                                            <li className="nav-item" role="presentation">
                                                <button className="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">
                                                    <div className="ehr-vital-sign">
                                                        <span className="ehr-sign-title d-block">Heart Rate</span>
                                                        <p><span className="ehr-sign-value">89</span> <span className="ehr-sign-params">bpm</span></p>
                                                    </div>
                                                </button>
                                            </li>
                                            <li className="nav-item" role="presentation">
                                                <button className="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">
                                                    <div className="ehr-vital-sign">
                                                        <span className="ehr-sign-title d-block">Blood Pressure</span>
                                                        <p><span className="ehr-sign-value">100/60</span> <span className="ehr-sign-params">mmHg</span></p>
                                                    </div>
                                                </button>
                                            </li>
                                            <li className="nav-item" role="presentation">
                                                <button className="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">
                                                    <div className="ehr-vital-sign">
                                                        <span className="ehr-sign-title d-block">Temperature</span>
                                                        <p><span className="ehr-sign-value">36.7&#176;</span> <span className="ehr-sign-params">c</span></p>
                                                    </div>
                                                </button>
                                            </li>
                                            <li className="nav-item" role="presentation">
                                                <button className="nav-link" id="pills-contact-tab1" data-bs-toggle="pill" data-bs-target="#pills-contact1" type="button" role="tab" aria-controls="pills-contact1" aria-selected="false">
                                                    <div className="ehr-vital-sign">
                                                        <span className="ehr-sign-title d-block">Oxygen</span>
                                                        <p><span className="ehr-sign-value">98</span> <span className="ehr-sign-params">%</span></p>
                                                    </div>
                                                </button>
                                            </li>
                                        </ul>
                                        <div className="tab-content" id="pills-tabContent">
                                            ...
                                            <div className="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab"> <Line data={userData} /> </div>
                                            <div className="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab"> <Line data={userData} /> </div>
                                            <div className="tab-pane fade" id="pills-contact1" role="tabpanel" aria-labelledby="pills-contact-tab1"> <Line data={userData} /> </div>
                                        </div>
                                    </div>
                        }
                    </div>
