        ...
        <div className='bg-white  ' style={{ overflowX: 'hidden' }}>
            <div className='page-filter d-flex p-2 '>
                <div className='col-12 d-flex justify-content-between '>
                    ...
                    <div className='col-3 filter_input_box'>
                    ...
                    <div className='page_box col-6 ms-5'>
                        ...
                        <label for="" className='ms-2'> of 12</label>
                        <div className='chevron_icon'>
                            <span><i class={`fa-solid fa-chevron-left ms-2 pe-2  ${pageNo === 1 ? `text-secondary` : `text-white`}`} onClick={
                                () => {
                                    if (pageNo !== 1) {
                                        setPageNo(pageNo - 1)
                                    }
                            ...
                            <span><i class={`fa-solid fa-chevron-right ms-2 pe-2  ${pageNo === 12 ? `text-secondary` : `text-white`}`} onClick={() => {
                                if (pageNo !== 12) {
                                    setPageNo(pageNo + 1)
                                }
                            }}></i></span>
            ...
            {pageName == 1 && <PaediatricPage1 closePaediatricExaminationModal={props.closePaediatricExaminationModal} passData={passData} passCancel={props} patient_id={props.patient_id}> </PaediatricPage1>}
            {pageName == 2 && <PaediatricPage2 closePaediatricExaminationModal={props.closePaediatricExaminationModal} passData={passData} passCancel={props}></PaediatricPage2>}

            {pageName == 3 && <PaediatricPage3 closePaediatricExaminationModal={props.closePaediatricExaminationModal} passData={passData} passCancel={props}></PaediatricPage3>}
            {pageName == 4 && <PaediatricPage4 closePaediatricExaminationModal={props.closePaediatricExaminationModal} passData={passData} passCancel={props}></PaediatricPage4>}
            {pageName == 5 && <PaediatricPage5 closePaediatricExaminationModal={props.closePaediatricExaminationModal} passData={passData} passCancel={props}></PaediatricPage5>}
            {pageName == 6 && <PaediatricPage6 closePaediatricExaminationModal={props.closePaediatricExaminationModal} passData={passData} passCancel={props}> </PaediatricPage6>}
            {pageName == 7 && <PaediatricPage7 closePaediatricExaminationModal={props.closePaediatricExaminationModal} passData={passData} passCancel={props}> </PaediatricPage7>}
            {pageName == 8 && <PaediatricPage8 closePaediatricExaminationModal={props.closePaediatricExaminationModal} passData={passData} passCancel={props}> </PaediatricPage8>}
            {pageName == 9 && <PaediatricPage9 closePaediatricExaminationModal={props.closePaediatricExaminationModal} passData={passData} passCancel={props}> </PaediatricPage9>}
            {pageName == 10 && <PaediatricPage10 closePaediatricExaminationModal={props.closePaediatricExaminationModal} passData={passData} passCancel={props}> </PaediatricPage10>}
            {pageName == 11 && <PaediatricPage11 closePaediatricExaminationModal={props.closePaediatricExaminationModal} passData={passData} passCancel={props}> </PaediatricPage11>}
            {pageName == 12 && <PaediatricPage12 closePaediatricExaminationModal={props.closePaediatricExaminationModal} passData={passData} passCancel={props}> </PaediatricPage12>}
        </div>
