...
function Add_employee() {
    ...
    const handleDoctorImageUrl = (event) => {
        ...
        if (event.target.files && event.target.files[0] && event.target.files[0].size < 2000048) {
            setDoctors({ ...employee, doctorImageUrl: URL.createObjectURL(event.target.files[0]) });
        } else {
            setdocImage_error("File size must be less than 2 mb !")
        }
    }
    ...
    const handleSignatureUrl = (event) => {
        ...
        if (event.target.files && event.target.files[0] && event.target.files[0].size < 2000048) {
            setDoctors({ ...employee, signatureImageUrl: URL.createObjectURL(event.target.files[0]) });
        } else {
            setsignature_error("File size must be less than 2 mb !")
        }
    }
    ...
    return (
        ...
        <div className="ms-2 mb-5 font-size-patient pt-2">
            <div className="custom-card">
                <h5 className="fw-normal  text-start py-2 px-1 mb-2 text-login">Add New Employees
                                        ...
                                        <div className="row">
                                            <div className="col-6">
                                                <div className="col-md-12 p-1 px-3">
                                                    <label htmlFor="inputEmail4"
                                                        className=""> Employee Identity No. <span style={{ color: "red" }}>*</span> </label>
                                                    <input name="identity_no" type="text" className="form-control form-control-sm "
                                                        onChange={handleInput} value={employee.identity_no} id="inputEmail4" />
                                                ...
                                                <div className="col-md-12 p-1 px-3">
                                                    ...
                                                    <select id="inputState" name="user_type_id" onChange={handleInput}
                                                ...
                                                <div className="col-md-12 p-1 px-3">
                                                    <label htmlFor="inputEmail4"
                                                        className="">Employee Title</label>
                                                    <select id="inputState" name="title" onChange={handleInput} value={employee.title}
                                                        className="form-select  col-form-label-sm font-size-patient">
                                                ...
                                                <div className="col-md-12 p-1 px-3">
                                                    ...
                                                    <input name="given_name" type="text" className="form-control form-control-sm "
                                                        onChange={handleInput} value={employee.given_name} id="inputEmail4" />

                                                </div>

                                                <div className="col-md-12 p-1 px-3">
                                                    <label htmlFor="inputEmail4"
                                                        className="">First Name <span style={{ color: "red" }}>*</span></label>
                                                    <input name="first_name" type="text" className="form-control form-control-sm "
                                                        onChange={handleInput} value={employee.first_name} id="inputEmail4" />
                                                ...
                                                <div className="col-md-12 p-1 px-3">
                                                    ...
                                                    <input name="middle_name" type="text" onChange={handleInput} value={employee.middle_name} className="form-control form-control-sm "
                                                        id="inputEmail4" />
                                                ...
                                                <div className="col-md-12 p-1 px-3">
                                                    ...
                                                    <input name="last_name" type="text" onChange={handleInput} value={employee.last_name} className="form-control form-control-sm "
                                                        id="inputEmail4" />
                                                ...
                                                <div className="col-md-12 p-1 px-3">
                                                    <label htmlFor="inputEmail4"
                                                        className="">Preferred
                                                        Name</label>
                                                    <input name="preferred_name" type="text" onChange={handleInput} value={employee.preferred_name} className="form-control form-control-sm "
                                                        id="inputEmail4" />
                                                ...
                                                <div className="col-md-12 px-3">
                                                    <label htmlFor="exampleFormControlTextarea1"
                                                        ...
                                                        1</label>
                                                    <textarea name="address_line_1" onChange={handleInput} value={employee.address_line_1} className="form-control" id="exampleFormControlTextarea1"
                                                        rows="2"></textarea>
                                                </div>
                                                <div className="col-md-12 p-1 px-3">
                                                    <label htmlFor="exampleFormControlTextarea1"
                                                        className="">Address Line
                                                        2</label>
                                                    <textarea name="address_line_2" onChange={handleInput} value={employee.address_line_2} className="form-control" id="exampleFormControlTextarea1"
                                                        rows="2"></textarea>
                                                </div>
                                                <div className="col-md-12 p-1 px-3">
                                                    <label htmlFor="inputEmail4"
                                                        className="">BMDC Reg No.</label>
                                                    <input type="text" name="bmdc_reg_no" className="form-control form-control-sm" onChange={handleInput} value={employee.bmdc_reg_no}
                                                        id="inputEmail4" />
                                                ...
                                                <div className="col-md-12 p-1 px-3 d-flex">
                                                    ...
                                                    {employee.doctorImageUrl == false ? '' :
                                                        <div className="docImage">
                                                            <img src={employee.doctorImageUrl} className="doctorImageUrlPreview" alt="preview image" />
                                            ...
                                            <div className="col-6">
                                                <div className="col-md-12 p-1 px-3">
                                                    ...
                                                    <input type="email" name="email" className="form-control form-control-sm" onChange={handleInput} value={employee.email}
                                                        id="inputEmail4" />
                                                ...
                                                <div className="col-md-12 p-1 px-3">
                                                    ...
                                                    <input type="date" name="dob" className="form-control form-control-sm" onChange={handleInput} value={employee.dob}
                                                        id="inputEmail4" />
                                                ...
                                                <div className="col-md-12 p-1 px-3">
                                                    ...
                                                    <select name="birth_sex_id" onChange={handleInput} value={employee.birth_sex_id} id="inputState"
                                                        className="form-select  col-form-label-sm font-size-patient">
                                                        <option selected>Select</option>
                                                ...
                                                <div className="col-md-12 p-1 px-3">
                                                    ...
                                                    <select id="inputState" name="city_id" onChange={handleInput} value={employee.city_id}
                                                        className="form-select  col-form-label-sm font-size-patient">
                                                        <option selected>Select</option>
                                                        {
                                                            citylist.map((item) => {
                                                ...
                                                <div className="col-md-12 p-1 px-3">
                                                    ...
                                                    <input type="text" name="postal_code" className="form-control form-control-sm" onChange={handleInput} value={employee.postal_code}
                                                        id="inputEmail4" />
                                                </div>
                                                <div className="col-md-12 p-1 px-3">
                                                    <label htmlFor="inputEmail4"
                                                        className="">Home Phone</label>
                                                    <input type="text" name="home_phone" className="form-control form-control-sm" onChange={handleInput} value={employee.home_phone}
                                                        id="inputEmail4" />
                                                ...
                                                <div className="col-md-12 p-1 px-3">
                                                    ...
                                                    <input type="text" name="work_phone" className="form-control form-control-sm" onChange={handleInput} value={employee.work_phone}
                                                        id="inputEmail4" />
                                                ...
                                                <div className="col-md-12 p-1 px-3">
                                                    ...
                                                    <input type="text" name="mobile_phone" className="form-control form-control-sm" onChange={handleInput} value={employee.mobile_phone}
                                                        id="inputEmail4" />
                                                </div>
                                                ...
                                                <div className="col-md-12 px-3">
                                                    ...
                                                    <select id="inputState"
                                                        name="contact_via_id" onChange={handleInput} value={employee.contact_via_id} className="form-select  col-form-label-sm font-size-patient">
                                                        <option selected>Select</option>
                                                ...
                                                <div className="col-md-12 px-3">
                                                    ...
                                                    <select id="inputState"
                                                        name="department_id" onChange={handleInput} value={employee.department_id} className="form-select  col-form-label-sm font-size-patient">
                                                        <option selected>Select</option>
                                                ...
                                                <div className="col-md-12 px-3">
                                                    ...
                                                    <select id="inputState"
                                                        name="specialists_id" onChange={handleInput} value={employee.specialists_id} className="form-select  col-form-label-sm font-size-patient">
                                                        <option selected>Select</option>
                                                        {
                                                ...
                                                <div className="col-md-12 p-1 px-3">
                                                    <label htmlFor="inputState"
                                                        className="">Usual
                                                        Provider</label>
                                                    <select id="inputState" name="provider_id" onChange={handleInput} value={employee.provider_id}
                                                        className="form-select col-form-label-sm font-size-patient">
                                                        <option selected>Select</option>
                                                ...
                                                <div className="col-md-12 px-3 d-flex">
                                                    <div>
                                                        <label htmlFor="doctorImageUrl"
                                                            className="">Employee Signature</label>
                                                        <input type="file" name="signatureImage" className="form-control form-control-sm" onChange={handleSignatureUrl}
                                                            id="signatureImageUrl" accept="image/jpg,image/jpeg,image/gif,image/png" />
                                                        {
                                                            setsignature_error == null ? <p className="doc_image_size">Image size must be less than 2 mb</p> : <p className="docimage_error">{signature_error}</p>
                                                        }
                                                    ...
                                                    {employee.signatureImageUrl == false ? '' :
                                                        <div className="docImage">
                                                            <img src={employee.signatureImageUrl} className="doctorImageUrlPreview" alt="preview image" />
                            ...
                            <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                                {
                                    CertificateArray.map((item, i) => {
                                        return (
                                            <div key={i} className="custom-card clearfix pb-2 mb-2">
                                                <div className="ml-3 pt-2 px-3">
                                                    <h6 className="card-title">Professional Certificates</h6>
                                                </div>
                                                <div className="card-body">
                                                    <div className="row">
                                                        <div className="col-6">
