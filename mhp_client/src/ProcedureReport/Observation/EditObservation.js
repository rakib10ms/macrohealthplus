...
const EditObservation = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-observation-name/${lastpart}`).then(res => {

            if (res.data.status === 200) {
                setObservationEdit(res.data.observationName);
    ...
    const handleInput = (e) => {
        setObservationEdit({ ...observationEdit, [e.target.name]: e.target.value });
    }
    ...
    const updatePathologyName = (e) => {
        ...
        axios.post(`/update-observation-name/${lastpart}`, observationEdit).then(res => {
            if (res.data.status === 200) {
                ...
                <div className="col-md-9 mt-3">
                    <div className="card">
                        <div className="card-header">
                            <h6 className="card-title">Edit Observation Name
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="col-md-12">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input type="text" value={observationEdit.name}className="form-control" name="name" onChange={handleInput} />
