...
const AddDvtPropName = () => {
    ...
    const saveDvtPropName =(e)=>{
     ...
     axios.post('/save-dvt-prop-name',dvtPropsName)
     .then(res => {
                                        ...
                                        <div className="card-body">
                                            <div className="col-md-12">
                                                <div className="form-group">
                                                    ...
                                                    <input type="text" className="form-control" value={dvtPropName.dvt_prop_name} name="dvt_prop_name" onChange={(e)=>{setDvtPropName(e.target.value)}}/>
