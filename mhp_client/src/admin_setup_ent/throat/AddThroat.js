...
function Addthroat() {
    ...
    const handleInput=(e)=>{
       setthroat({
           ...throat,[e.target.name]:e.target.value
       });
    }

    const submitthroat=(e)=>{     
        e.preventDefault();
        const data={
            throat_name:throat.throat_name,
           status_id:throat.status_id,
            selection_criteria:throat.selection_criteria,
        }
        
        axios.post(`/save-throat`,data).then(res=>{
            if(res.data.status==200){
               ...
               status_id:"",
                ...
                setthroat({ ...throat, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add Throat
                        <Link to={'/throat'} className="btn btn-primary btn-sm float-end"> Back </Link>
                    </h6>
                </div>
                <div className="card-body">
                    <form id="EarCanalForm" onSubmit={submitthroat}>
                        <div className="card-body">
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{throat.error_list.throat_name}</span>
                    ...
                    <span className="text-danger">{throat.error_list.status_id}</span>
         ...
         <div className='form-group mt-3'>
            ...
            <span className="text-danger">{throat.error_list.selection_criteria}</span>
