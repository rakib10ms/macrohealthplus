...
function EditEarDischarge(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-ear-discharge/${lastpart}`).then(res => {

            if (res.data.status === 200) {
                // console.log(res.data.EarDischarge);
                setEarDischarge(res.data.EarDischarge);
                // setPicture(res.data.EarDischarge.image);
    ...
    const handleInput = (e) => {
        e.persist();
        setEarDischarge({ ...EarDischarge, [e.target.name]: e.target.value });
    }

    const updateEarDischargeInput = (e) => {
        e.preventDefault();
        ...
        axios.post(`/update-ear-discharge/${lastpart}`, formData).then(res => {
            if (res.data.status === 200) {
                    ...
                    <div className="col-md-9 mt-3">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <form id="EarDischargeForm" onSubmit={updateEarDischargeInput}>
                                    <div className="card-body">
                                        ...
                                        <div className="col-md-12">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <span className="text-danger">{error.EarDischarge_name}</span>
                                            </div>
...
export default EditEarDischarge;
