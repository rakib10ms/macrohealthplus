...
function Addposterior() {
    ...
    const handleInput=(e)=>{
       setposterior({
           ...posterior,[e.target.name]:e.target.value
       });
    }

    const submitposterior=(e)=>{     
        e.preventDefault();
        const data={
            posterior_name:posterior.posterior_name,
           status_id:posterior.status_id,
            selection_criteria:posterior.selection_criteria,
        }
    
        axios.post(`/save-posterior`,data).then(res=>{
            if(res.data.status==200){
               ...
               status_id:"",
                ...
                setposterior({ ...posterior, error_list: res.data.errors });
        ...
        <div className="col-md-9 mt-3">
            <div className="card">
                <div className="card-header">
                    <h6 className="card-title"> Add Posterior
                        <Link to={'/posterior'} className="btn btn-primary btn-sm float-end"> Back </Link>
                    </h6>
                </div>
                <div className="card-body">
                    <form id="PosteriorForm" onSubmit={submitposterior}>
                        <div className="card-body">
                ...
                <div className="col-md-12">
                    ...
                    <div className="form-group">
                        ...
                        <span className="text-danger">{posterior.error_list.posterior_name}</span>
                    ...
                    <span className="text-danger">{posterior.error_list.status_id}</span>
         ...
         <div className='form-group mt-3'>
            ...
            <span className="text-danger">{posterior.error_list.selection_criteria}</span>
