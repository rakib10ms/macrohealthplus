...
function EditTongue(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-tongue/${lastpart}`).then(res => {
    ...
    const updatetongue= (e) => {
        ...
        const data = tongue;
        axios.post(`/update-tongue/${lastpart}`, data).then(res => {
            if (res.data.status === 200) {
        ...
        <div className="row">
            ...
            <div className="card">
                ...
                <div className="card-body">
                    <form id="EartongueForm" onSubmit={updatetongue}>
                        <div className="card-body">
