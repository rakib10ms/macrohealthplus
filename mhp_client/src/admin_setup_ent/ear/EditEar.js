...
function EditEar(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-ear/${lastpart}`).then(res => {

            if (res.data.status === 200) {
                // console.log(res.data.Ear);
                setEar(res.data.Ear);
    ...
    const updateEarInput = (e) => {
        ...
        axios.post(`/update-ear/${lastpart}`, formData).then(res => {
            if (res.data.status === 200) {
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="col-md-12">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <span className="text-danger">{error.Ear_name}</span>
                                            </div>
