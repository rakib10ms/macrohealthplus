...
function EditRadiologyTestType(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-radiology-test-type/${lastpart}`).then(res => {
    ...
    const handleInput = (e) => {
        e.persist();
        setRadiologyTestType({ ...RadiologyTestType, [e.target.name]: e.target.value });
    }

    const updateRadiologyTestTypeInput = (e) => {
        e.preventDefault();
        ...
        axios.post(`/update-radiology-test-type/${lastpart}`, RadiologyTestType).then(res => {
            if (res.data.status === 200) {
                    ...
                    <div className="col-md-9 mt-3">
                        <div className="card">
                            <div className="card-header">
                                <h6 className="card-title"> Edit Radiology Test Type
                                    <Link to={'/radiology-test-type'} className="btn btn-primary btn-sm float-end"> Back </Link>
                                </h6>
                            </div>
                            <div className="card-body">
                                <form id="RadiologyTestTypeForm" onSubmit={updateRadiologyTestTypeInput}>
                                    <div className="card-body">
                                        ...
                                        <div className="col-md-12">
                                            ...
                                            <div className="form-group">
                                                ...
                                                {/* <span className="text-danger">{error.RadiologyTestType_name}</span> */}
                                            </div>
...
export default EditRadiologyTestType;
